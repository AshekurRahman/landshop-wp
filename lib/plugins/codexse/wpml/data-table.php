...
class WPML_Data_Table_Column_Data extends \WPML_Elementor_Module_With_Items  {
	...
	protected function get_title( $field ) {
		switch ( $field ) {
			case 'column_name':
				return __( 'Data Table: Column Name', 'codexse-elementor-addons' );
			default:
				return '';
		}
	}
...
class WPML_Data_Table_Row_Data extends \WPML_Elementor_Module_With_Items  {
	...
	protected function get_title( $field ) {
		switch ( $field ) {
			case 'cell_name':
				return __( 'Data Table: Cell Title', 'codexse-elementor-addons' );
			case 'url':
				return __( 'Data Table: Cell Link', 'codexse-elementor-addons' );
			default:
				return '';
		}
	}
