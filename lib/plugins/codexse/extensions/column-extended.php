...
class Column_Extended {
    ...
    public static function add_controls( Element_Column $element ) {
        $element->add_responsive_control(
            '_cx_column_width',
            [
                'label' => __( 'Custom Column Width', 'codexse-elementor-addons' ),
                'type' => Controls_Manager::TEXT,
                'separator' => 'before',
                'label_block' => true,
                'description' => __( 'Here you can set the column width the way you always wanted to! e.g 250px, 50%, calc(100% - 250px)', 'codexse-elementor-addons' ),
                'selectors' => [
        ...
        $element->add_responsive_control(
            '_cx_column_order',
            [
                'label' => __( 'Column Order', 'codexse-elementor-addons' ),
                ...
                'description' => sprintf(
                    __( 'Column ordering is a great addition for responsive design. You can learn more about CSS order property from %sMDN%s.', 'codexse-elementor-addons' ),
                    '<a
