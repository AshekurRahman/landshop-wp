...
class TwentyNineteen {
	...
	public function get_header( $name ) {
		add_action('codexseaddons/template/after_header', function(){
			echo '<div id="page" class="site">';
			echo '<div id="content" class="site-content">';
		});
		// require __DIR__ . '/../views/theme-support-header.php';
		require(CODEXSE_ADDONS_DIR_PATH . 'templates/builder/theme-support-header.php');
	...
	public function get_footer( $name ) {
		add_action('codexseaddons/template/after_footer', function(){
			echo '</div></div>';
		});

		// require __DIR__ . '/../views/theme-support-footer.php';
		require(CODEXSE_ADDONS_DIR_PATH . 'templates/builder/theme-support-footer.php');
