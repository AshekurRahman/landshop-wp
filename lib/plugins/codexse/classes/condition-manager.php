...
class Condition_Manager {
    ...
    public function __construct() {
        ...
        add_action('wp_ajax_cx_condition_autocomplete', [$this, 'process_autocomplete']);
        add_action('wp_ajax_cx_condition_update', [$this, 'process_condition_update']);
        add_action('wp_ajax_cx_cond_template_type', [$this, 'cx_get_template_type']);
        add_action('wp_ajax_cx_cond_get_current', [$this, 'cx_get_current_condition']);
    ...
    private function initial_conditions() {
        $conditions = [
            'general' => [
                'title' => __('General', 'codexse-elementor-addons'),
                'all_label' => __('Entire Site', 'codexse-elementor-addons'),
                'is_pro' => false,
            ],
            'archive' => [
                'title' => __('Archives', 'codexse-elementor-addons'),
                'all_label' => __('All Archives', 'codexse-elementor-addons'),
                'is_pro' => false,
            ],
            'singular' => [
                'title' => __('Singular', 'codexse-elementor-addons'),
                'all_label' => __('All Singular', 'codexse-elementor-addons'),
                'is_pro' => false,
            ],
        ];
    ...
    private function archive_conditions() {
        $conditions = [
            'all' => [
                'title' => __('All Archives', 'codexse-elementor-addons'),
                'all_label' => __('All Archives', 'codexse-elementor-addons'),
                'is_pro' => false,
            ],
            'author' => [
                'title' => __('Author Archive', 'codexse-elementor-addons'),
                'all_label' => __('Author Archive', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
            'date' => [
                'title' => __('Date Archive', 'codexse-elementor-addons'),
                'all_label' => __('Date Archive', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
            'search' => [
                'title' => __('Search Results', 'codexse-elementor-addons'),
                'all_label' => __('Search Results', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
            'post_archive' => [
                'title' => __('Posts Archive', 'codexse-elementor-addons'),
                'all_label' => __('Posts Archive', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
        ];

        return apply_filters('codexseaddons/conditions/archive', $conditions);
    }
    ...
    private function singular_conditions() {
        $conditions = [
            'all' => [
                'title' => __('All Singular', 'codexse-elementor-addons'),
                'all_label' => __('All Singular', 'codexse-elementor-addons'),
                'is_pro' => false,
            ],
            'front_page' => [
                'title' => __('Front Page', 'codexse-elementor-addons'),
                'all_label' => __('Front Page', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
            'post_group' => [
                'title' => __('Posts', 'codexse-elementor-addons'),
                'all_label' => __('Posts', 'codexse-elementor-addons'),
                'type' => 'condition-group',
                'conditions' => [
                    'post' => [
                        'title' => __('Posts', 'codexse-elementor-addons'),
                        'all_label' => __('All Posts', 'codexse-elementor-addons'),
                        'is_pro' => true,
                    ],
                    'in_category' => [
                        'title' => __('In Category', 'codexse-elementor-addons'),
                        'all_label' => __('Site', 'codexse-elementor-addons'),
                        'is_pro' => true,
                    ],
                    ...
                    'in_post_tag' => [
                        'title' => __('In Tag', 'codexse-elementor-addons'),
                        'all_label' => __('Site', 'codexse-elementor-addons'),
                        'is_pro' => true,
                    ],
                    'post_by_author' => [
                        'title' => __('Posts By Author', 'codexse-elementor-addons'),
                        'all_label' => __('Posts By Author', 'codexse-elementor-addons'),
                        'is_pro' => true,
                    ],
                ]
            ],
            'page_group' => [
                'title' => __('Page', 'codexse-elementor-addons'),
                'all_label' => __('Site', 'codexse-elementor-addons'),
                'type' => 'condition-group',
                'is_pro' => true,
                'conditions' => [
                    'page' => [
                        'title' => __('Pages', 'codexse-elementor-addons'),
                        'all_label' => __('All Pages', 'codexse-elementor-addons'),
                        'is_pro' => true,
                    ],
                    'page_by_author' => [
                        'title' => __('Pages By Author', 'codexse-elementor-addons'),
                        'all_label' => __('Pages By Author', 'codexse-elementor-addons'),
                        'is_pro' => true,
                    ],
                ]
            ],
            'child_of' => [
                'title' => __('Direct Child Of', 'codexse-elementor-addons'),
                'all_label' => __('Direct Child Of', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
            'any_child_of' => [
                'title' => __('Any Child Of', 'codexse-elementor-addons'),
                'all_label' => __('Any Child Of', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
            'by_author' => [
                'title' => __('By Author', 'codexse-elementor-addons'),
                'all_label' => __('By Author', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
            'not_found404' => [
                'title' => __('404 Page', 'codexse-elementor-addons'),
                'all_label' => __('404 Page', 'codexse-elementor-addons'),
                'is_pro' => true,
            ],
        ];


        return apply_filters('codexseaddons/conditions/singular', $conditions);
    }
    ...
    protected function validate_reqeust() {
        ...
        if (!wp_verify_nonce($nonce, 'cx_editor_nonce')) {
    ...
    public function cx_get_template_type() {
        try {
            //$this->validate_reqeust();
            $id = isset($_REQUEST['post_id']) ? absint($_REQUEST['post_id']) : null;
            if ($id) {
                $tpl_type = get_post_meta($id, '_cx_library_type', true);
    ...
    public function process_condition_update() {
        try {
            ...
            $requestConditions = isset($_REQUEST['conds']) ? cx_sanitize_array_recursively($_REQUEST['conds']) : [];

            // error_log(print_r($templateID), true);
            // error_log(print_r($requestConditions), true);

            $exitsConditions = get_post_meta($templateID, '_cx_display_cond', true);

            $mergedConditions = !empty( $exitsConditions ) ? array_diff($requestConditions, $exitsConditions) : $requestConditions;

            if ($templateID) {

                $allExtitsCondition = $this->cx_get_all_conditions();
                $templateType = get_post_meta($templateID, '_cx_library_type', true);

                $duplicate = $this->cx_check_template_conditions($templateType, $requestConditions, $mergedConditions, $allExtitsCondition);

                if (!$duplicate) {
                    $cond = update_post_meta($templateID, '_cx_display_cond', array_unique($requestConditions));
                    $updates = get_post_meta($templateID, '_cx_display_cond');
                    ...
                    wp_send_json_error(['msg' => esc_html__('Unable to save, conflicting include exclude condition detected. Please change the conditions accordingly.', 'codexse-elementor-addons')]);
                }
     ...
     * @return boolean
     */
    private function cx_check_template_conditions($template_type = '', $requestConditions = [], $mergedConditions=[], $exitsConditions = []) {
        $result = false;
    ...
    public function process_condition_update_old() {
        try {
            ...
            $existed_conditions = get_post_meta($templateID, '_cx_display_cond', true);

            $new_conditions = array_diff($conditions, $existed_conditions);

            if ($templateID) {
                $all_cond = $this->cx_get_all_conditions();
                $tbl_type = get_post_meta($templateID, '_cx_library_type', true);
                ...
                if (!$duplicate) {
                    $cond = update_post_meta($templateID, '_cx_display_cond', $conditions);
                    $updates = get_post_meta($templateID, '_cx_display_cond');
                    ...
                    wp_send_json_error(['msg' => esc_html__('Unable to save because condition already exists', 'codexse-elementor-addons')]);
                }
     ...
     * @return array
     */
    public function cx_get_all_conditions() {

        $conditions = [];

        // WP_Query arguments
        $args = array(
            'post_type'              => array('cx_library'), // use any for any kind of post type, custom post type slug for custom post type
        ...
        if ($query->have_posts()) {
            while ($query->have_posts()) {
                ...
                $saved_conditions = get_post_meta(get_the_ID(), '_cx_display_cond', true);
                $tpl_type = get_post_meta(get_the_ID(), '_cx_library_type', true);
    ...
    public function cx_get_current_condition() {
        try {
            // $this->validate_reqeust();
            $templateID = isset($_REQUEST['template_id']) ? absint($_REQUEST['template_id']) : null;
            // wp_send_json_success($templateID);
            if ($templateID) {
                $cond = get_post_meta($templateID, '_cx_display_cond', true);
                if ($cond) {
                    ob_start();
    ...
    private function cond_to_html($cond) {
        ...
        foreach ($cond as $condition) {
            ...
            $html .= <<<EOF
<div id="cx-template-condition-item-$uuid" class="cx-template-condition-item">
    <div class="cx-template-condition-item-row">
        <div class="cx-tce-type">
...
EOF;
    ...
    private function check_cond_sub_name($sub_name, $parsed_condition) {
        ...
        return apply_filters('codexseaddons/conditions/check/cond_sub_id', $sub_name, $parsed_condition);
    }
