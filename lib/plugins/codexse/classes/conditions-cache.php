...
class Conditions_Cache {
    ...
    const OPTION_NAME = 'codexse_theme_elements_conditions';
    ...
    public function regenerate() {
        ...
        $query = new \WP_Query([
            ...
            'fields' => 'ids',
            'meta_key' => '_cx_display_cond',
        ]);

        foreach ($query->posts as $post_id) {
            $conditions = get_post_meta($post_id,'_cx_display_cond',true);
            $location = get_post_meta($post_id,'_cx_library_type',true);
