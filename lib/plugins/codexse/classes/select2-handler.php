...
class Select2_Handler {
	...
	public static function init() {
		add_action( 'wp_ajax_cx_process_dynamic_select', [ __CLASS__, 'process_request' ] );
	}
	...
	public static function process_post() {
		...
		$saved_values = ! empty( $_REQUEST['saved_values'] ) ? cx_sanitize_array_recursively($_REQUEST['saved_values']) : 0;
