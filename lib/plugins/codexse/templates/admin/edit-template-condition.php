...
<script type="text/template" id="tmpl-modal-template-condition">
    <div class="modal micromodal-slide modal-template-condition cx-template-element-modal" id="modal-new-template-condition" aria-hidden="false">
            ...
            <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-login-title">
                ...
                <div class="modal__content" id="modal-2-content">
                    <div class="form-data">
                        ...
                        <p class="cx-template-notice"></p>
                        <form id="cx-template-edit-form">
                            <div class="cx-template-condition-wrap"></div>
                            <button class="cx-cond-repeater-add" type="button">+ Add Condition</button>
                        </form>
                    </div>
                </div>
                <footer class="modal__footer">
                    <button class="modal__close modal__btn" aria-label="Close modal" data-micromodal-close="">Cancel</button>
                    <button id="cx-template-save-data" class="modal__btn modal__btn-primary">Save & Close</button>
                </footer>
            </div>
        </div>
    </div>
...
<script type="text/template" id="tmpl-elementor-new-template">
    <div id="cx-template-condition-item-{{uniqeID}}" class="cx-template-condition-item">
        <div class="cx-template-condition-item-row">
            ...
            <div class="cx-tce-sub_name" style="display:none">
                <select data-id="sub_name-{{uniqeID}}" data-parent="{{uniqeID}}" data-setting="sub_name">
                </select>
            </div>
            <div class="cx-tce-sub_id" style="display:none">
