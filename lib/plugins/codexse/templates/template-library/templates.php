...
<script type="text/template" id="tmpl-haTemplateLibrary__header-back">
	...
	<span><?php echo __( 'Back to Library', 'codexse-elementor-addons' ); ?></span>
</script>
...
<script type="text/template" id="tmpl-haTemplateLibrary__header-menu-responsive">
	<div class="elementor-component-tab haTemplateLibrary__responsive-menu-item elementor-active" data-tab="desktop">
		<i class="eicon-device-desktop" aria-hidden="true" title="<?php esc_attr_e( 'Desktop view', 'codexse-elementor-addons' ); ?>"></i>
		<span class="elementor-screen-only"><?php esc_html_e( 'Desktop view', 'codexse-elementor-addons' ); ?></span>
	</div>
	<div class="elementor-component-tab haTemplateLibrary__responsive-menu-item" data-tab="tab">
		<i class="eicon-device-tablet" aria-hidden="true" title="<?php esc_attr_e( 'Tab view', 'codexse-elementor-addons' ); ?>"></i>
		<span class="elementor-screen-only"><?php esc_html_e( 'Tab view', 'codexse-elementor-addons' ); ?></span>
	</div>
	<div class="elementor-component-tab haTemplateLibrary__responsive-menu-item" data-tab="mobile">
		<i class="eicon-device-mobile" aria-hidden="true" title="<?php esc_attr_e( 'Mobile view', 'codexse-elementor-addons' ); ?>"></i>
		<span class="elementor-screen-only"><?php esc_html_e( 'Mobile view', 'codexse-elementor-addons' ); ?></span>
	</div>
</script>
...
<script type="text/template" id="tmpl-haTemplateLibrary__header-actions">
	<div id="haTemplateLibrary__header-sync" class="elementor-templates-modal__header__item">
		<i class="eicon-sync" aria-hidden="true" title="<?php esc_attr_e( 'Sync Library', 'codexse-elementor-addons' ); ?>"></i>
		<span class="elementor-screen-only"><?php esc_html_e( 'Sync Library', 'codexse-elementor-addons' ); ?></span>
	</div>
</script>
...
<script type="text/template" id="tmpl-haTemplateLibrary__insert-button">
	<a class="elementor-template-library-template-action elementor-button haTemplateLibrary__insert-button">
		...
		<span class="elementor-button-title"><?php esc_html_e( 'Insert', 'codexse-elementor-addons' ); ?></span>
	</a>
</script>
...
<script type="text/template" id="tmpl-haTemplateLibrary__loading">
	<div class="elementor-loader-wrapper">
		...
		<div class="elementor-loading-title"><?php esc_html_e( 'Loading', 'codexse-elementor-addons' ); ?></div>
	</div>
</script>
	...
	<div id="haTemplateLibrary__toolbar">
		<div id="haTemplateLibrary__toolbar-filter" class="haTemplateLibrary__toolbar-filter">
			<# if (ha.library.getTypeTags()) { var selectedTag = ha.library.getFilter( 'tags' ); #>
				...
				<# } else { #>
				<span class="haTemplateLibrary__filter-btn"><?php esc_html_e( 'Filter', 'codexse-elementor-addons' ); ?> <i class="eicon-caret-right"></i></span>
				<# } #>
		...
		<div id="haTemplateLibrary__toolbar-search">
			<label for="haTemplateLibrary__search" class="elementor-screen-only"><?php esc_html_e( 'Search Templates:', 'codexse-elementor-addons' ); ?></label>
			<input id="haTemplateLibrary__search" placeholder="<?php esc_attr_e( 'Search', 'codexse-elementor-addons' ); ?>">
...
<script type="text/template" id="tmpl-haTemplateLibrary__template">
	<div class="haTemplateLibrary__template-body" id="haTemplate-{{ template_id }}">
		...
		<# if ( obj.isPro ) { #>
		<span class="haTemplateLibrary__template-badge"><?php esc_html_e( 'Pro', 'codexse-elementor-addons' ); ?></span>
		<# } #>
	</div>
	<div class="haTemplateLibrary__template-footer">
		...
		<a href="#" class="elementor-button haTemplateLibrary__preview-button">
			...
			<?php esc_html_e( 'Preview', 'codexse-elementor-addons' ); ?>
		</a>
	</div>
</script>
