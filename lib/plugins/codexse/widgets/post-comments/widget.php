...
class Post_Comments extends Base {
	...
	public function get_title() {
		return __('Post Comments', 'codexse-elementor-addons');
	}
	...
	protected function __post_comments_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __('Post Comments', 'codexse-elementor-addons'),
		...
		$this->add_control(
			'source_type',
			[
				'label' => esc_html__('Source', 'codexse-elementor-addons'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'current_post' => esc_html__('Current Post', 'codexse-elementor-addons'),
					'custom' => esc_html__('Custom', 'codexse-elementor-addons'),
				],
		...
		$this->add_control(
			'source_custom',
			[
				'label' => esc_html__('Search & Select', 'codexse-elementor-addons'),
				'type' => Select2::TYPE,
				'multiple' => false,
	...
	protected function __post_comments_style_controls() {
		...
		$this->start_controls_section(
			'label_style',
			[
				'label' => esc_html__('Comments', 'codexse-elementor-addons'),
		...
		$this->add_control(
			'cx_pc_desc_link',
			[
				'label' => __('Description Link', 'codexse-elementor-addons'),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Link Typography', 'codexse-elementor-addons'),
	...
	protected function __post_comments_textarea_style_controls() {
		$this->start_controls_section(
			'textarea_style',
			[
				'label' => esc_html__('Textarea', 'codexse-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);

		$this->add_control(
			'cx_pc_textarea_label_style',
			[
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Label Color', 'codexse-elementor-addons'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'cx_pc_textarea_input_style',
			[
				'label' => __('Textarea Input', 'codexse-elementor-addons'),
				'type' => Controls_Manager::HEADING,
			]
		);
	...
	protected function __post_comments_button_style_controls() {
		...
		$this->start_controls_section(
			'pc_button_style',
			[
				'label' => esc_html__('Submit Button', 'codexse-elementor-addons'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
	...
	protected function render() {
		...
		if ('custom' === $settings['source_type']) {
			...
			cx_elementor()->db->switch_to_post($post_id);
		}

		if (!comments_open() && (cx_elementor()->preview->is_preview_mode() || cx_elementor()->editor->is_edit_mode())) :
?>
...
<?php
		...
		if ('custom' === $settings['source_type']) {
			cx_elementor()->db->restore_current_post();
		}
	}
}
