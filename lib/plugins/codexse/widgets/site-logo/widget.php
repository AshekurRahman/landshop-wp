...
class Site_Logo extends Base {
	...
	public function get_title() {
		return __('Site Logo', 'codexse-elementor-addons');
	}

	public function get_custom_help_url() {
		return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/site-logo/';
	}
	...
	protected function register_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'custom' => [
						'title' => __('Custom', 'codexse-elementor-addons'),
		...
		$this->add_control(
			'sitelogo_image',
			[
				'label' => __('Site Logo', 'codexse-elementor-addons'),
	...
	protected function __site_logo_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __('Logo style', 'codexse-elementor-addons'),
