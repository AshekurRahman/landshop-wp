...
class GravityForms extends Base {
	...
	public function get_title() {
		return __( 'Gravity Forms', 'codexse-elementor-addons' );
	}

	public function get_custom_help_url() {
		return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/gravity-forms/';
	}
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => cx_is_gravityforms_activated() ? __( 'Gravity Forms', 'codexse-elementor-addons' ) : __( 'Missing Notice',
		...
		if ( ! cx_is_gravityforms_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'raw' => sprintf(
						__( 'Hello %1$s, looks like Gravity Forms is missing in your site. Please install/activate Gravity Forms. Make sure to refresh this page after installation or activation.', 'codexse-elementor-addons' ),
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'options' => ['' => __( '', 'codexse-elementor-addons' ) ] + \cx_get_gravity_forms(),
				]
			);
			...
			$this->add_control(
				'form_title_show',
				[
					'label' => __( 'Form Title', 'codexse-elementor-addons' ),
			...
			$this->add_control(
				'ajax',
				[
					'label' => __( 'Enable Ajax Submit', 'codexse-elementor-addons' ),
					'type' => Controls_Manager::SWITCHER,
	...
	protected function __form_fields_label_style_controls() {
		...
		$this->add_responsive_control(
			'label_padding',
			[
				'label' => __( 'Label Padding', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'sub_label_margin',
			[
				'label' => __( 'Sub Label Margin', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'separator' => 'after',
				'selectors' => [
	...
	protected function __form_fields_break_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Break', 'codexse-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'page_break',
			[
				'label' => __( 'Page Break', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Progress bar background Color', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Padding', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Button Box Shadow', 'codexse-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Border Radius', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Button Typography', 'codexse-elementor-addons' ),
				'selector' => '{{WRAPPER}} .gform_next_button.button, {{WRAPPER}} .gform_previous_button.button',
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_ACCENT,
				],
	...
	protected function __form_fields_list_style_controls() {
		...
		$this->add_responsive_control(
			'list_button_size',
			[
				'label' => __( 'Button Size', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default' => [
					'unit' => 'px',
	...
	protected function render() {
		if ( ! cx_is_gravityforms_activated() ) {
			cx_show_plugin_missing_alert( __( 'Gravity Forms', 'codexse-elementor-addons' ) );
			return;
		}
