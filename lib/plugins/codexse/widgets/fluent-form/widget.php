...
class Fluent_Form extends Base {
    ...
    public function get_title() {
        return __( 'Fluent Form', 'codexse-elementor-addons' );
    }
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => cx_is_fluent_form_activated() ? __( 'Fluent Form', 'codexse-elementor-addons' ) : __( 'Missing Notice', 'codexse-elementor-addons' ),
        ...
        if ( ! cx_is_fluent_form_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'options' => ['' => __( 'Select a Form', 'codexse-elementor-addons' ) ] + \cx_get_fluent_forms(),
				]
			);
    ...
    protected function __fields_label_style_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Check Box Label Color', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'help_text_heading',
			[
				'label' => __( 'Help Text', 'codexse-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Arrow Color', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    protected function render() {
        if ( ! cx_is_fluent_form_activated() ) {
			cx_show_plugin_missing_alert(__( 'Fluent Form', 'codexse-elementor-addons' ) );
            return;
        }
        ...
        if ( ! empty( $settings['form_id'] ) ) {
            echo cx_do_shortcode( 'fluentform', [
                'id' => $settings['form_id'],
			] );
        }
    }
