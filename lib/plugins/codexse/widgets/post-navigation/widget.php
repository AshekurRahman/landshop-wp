...
class Post_Navigation extends Base {
    ...
    public function get_title() {
        return __('Post Navigation', 'codexse-elementor-addons');
    }

    public function get_custom_help_url() {
        return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/post-navigation/';
    }
    ...
    protected function __post_navigation_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __('Post Navigation', 'codexse-elementor-addons'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Previous', 'codexse-elementor-addons'),
                'condition' => [
                    'show_label' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Next', 'codexse-elementor-addons'),
                'condition' => [
                    'show_label' => 'yes',
                ],
                'dynamic' => [
        ...
        $this->add_control(
            'show_arrow',
            [
                'label' => esc_html__('Arrows', 'codexse-elementor-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'codexse-elementor-addons'),
                'label_off' => esc_html__('Hide', 'codexse-elementor-addons'),
                'default' => 'yes',
        ...
        $this->add_control(
            'arrow',
            [
                'label' => esc_html__('Arrows Type', 'codexse-elementor-addons'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'fa fa-angle-left' => esc_html__('Angle', 'codexse-elementor-addons'),
                    'fa fa-angle-double-left' => esc_html__('Double Angle', 'codexse-elementor-addons'),
                    'fa fa-chevron-left' => esc_html__('Chevron', 'codexse-elementor-addons'),
                    'fa fa-chevron-circle-left' => esc_html__('Chevron Circle', 'codexse-elementor-addons'),
                    'fa fa-caret-left' => esc_html__('Caret', 'codexse-elementor-addons'),
                    'fa fa-arrow-left' => esc_html__('Arrow', 'codexse-elementor-addons'),
                    'fa fa-long-arrow-left' => esc_html__('Long Arrow', 'codexse-elementor-addons'),
                    'fa fa-arrow-circle-left' => esc_html__('Arrow Circle', 'codexse-elementor-addons'),
                    'fa fa-arrow-circle-o-left' => esc_html__('Arrow Circle Negative', 'codexse-elementor-addons'),
                ],
        ...
        $this->add_control(
            'show_title',
            [
                'label' => esc_html__('Post Title', 'codexse-elementor-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'codexse-elementor-addons'),
                'label_off' => esc_html__('Hide', 'codexse-elementor-addons'),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_borders',
            [
                'label' => esc_html__('Borders', 'codexse-elementor-addons'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'codexse-elementor-addons'),
                'label_off' => esc_html__('Hide', 'codexse-elementor-addons'),
                'default' => 'yes',
                'prefix_class' => 'cx-post-navigator-borders-',
            ]
        );
        ...
        $this->add_control(
            'in_same_term',
            [
                'label' => esc_html__('In same Term', 'codexse-elementor-addons'),
                'type' => Controls_Manager::SELECT2,
                'options' => $post_type_options,
                'default' => '',
                'multiple' => true,
                'label_block' => true,
                'description' => esc_html__('Indicates whether next post must be within the same taxonomy term as the current post, this lets you set a taxonomy per each post type', 'codexse-elementor-addons'),
            ]
        );
        ...
        foreach ($post_type_options as $post_type => $post_type_label) {
            $this->add_control(
                $post_type . '_taxonomy',
                [
                    'label' => $post_type_label . ' ' . esc_html__('Taxonomy', 'codexse-elementor-addons'),
                    'type' => Controls_Manager::SELECT,
    ...
    protected function __post_navigation_style_controls() {
        ...
        $this->start_controls_section(
            'arrow_style',
            [
                'label' => esc_html__('Arrow', 'codexse-elementor-addons'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_arrow' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                //'default' => '#D4D4D4',
                'selectors' => [
                    '{{WRAPPER}} .cx-post-navigator__separator' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .cx-post-navigator' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .cx-post-navigator__separator' => 'width: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .cx-post-navigator' => 'border-top-width: {{SIZE}}{{UNIT}}; border-bottom-width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .cx-post-navigator__next.cx-post-navigator__link' => 'width: calc(50% - ({{SIZE}}{{UNIT}} / 2))',
                    '{{WRAPPER}} .cx-post-navigator__prev.cx-post-navigator__link' => 'width: calc(50% - ({{SIZE}}{{UNIT}} / 2))',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'borders_spacing',
            [
                'label' => esc_html__('Spacing', 'codexse-elementor-addons'),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .cx-post-navigator' => 'padding: {{SIZE}}{{UNIT}} 0;',
                ],
                'range' => [
                    'em' => [
                        'min' => 0,
    ...
    protected function render() {
        ...
        if ('yes' === $settings['show_arrow']) {
            ...
            $prev_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-prev"><i class="' . $prev_icon_class . '" aria-hidden="true"></i><span class="elementor-screen-only">' . esc_html__('Prev', 'codexse-elementor-addons') . '</span></span>';
            $next_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-next"><i class="' . $next_icon_class . '" aria-hidden="true"></i><span class="elementor-screen-only">' . esc_html__('Next', 'codexse-elementor-addons') . '</span></span>';
        }
...
?>
        <div class="cx-post-navigator">
            <div class="cx-post-navigator__prev cx-post-navigator__link">
                <?php previous_post_link('%link', $prev_arrow . '<span class="cx-post-navigator__link__prev">' . $prev_label . $prev_title . '</span>', $in_same_term, '', $taxonomy); ?>
            </div>
            <?php if ('yes' === $settings['show_borders']) : ?>
                <div class="cx-post-navigator__separator-wrapper">
                    <div class="cx-post-navigator__separator"></div>
                </div>
            <?php endif; ?>
            <div class="cx-post-navigator__next cx-post-navigator__link">
                <?php next_post_link('%link', '<span class="cx-post-navigator__link__next">' . $next_label . $next_title . '</span>' . $next_arrow, $in_same_term, '', $taxonomy); ?>
            </div>
        </div>
<?php
    }
