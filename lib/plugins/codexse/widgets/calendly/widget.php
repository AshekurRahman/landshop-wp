...
class Calendly extends Base {
	...
	public function get_title() {
		return __( 'Calendly', 'codexse-elementor-addons' );
	}

    public function get_custom_help_url() {
        return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/calendly/';
    }
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_calendly',
			[
				'label' => __( 'Calendly', 'codexse-elementor-addons' ),
		...
		$this->add_control(
			'calendly_username',
			[
				'label'       => __( 'Username', 'codexse-elementor-addons' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => 'codexseaddons',
				'placeholder' => __( 'Type calendly username here', 'codexse-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			'calendly_time',
			[
				'label'   => __( 'Time Slot', 'codexse-elementor-addons' ),
				'type'    => Controls_Manager::SELECT,
				'options' => [
					'15min' => __( '15 Minutes', 'codexse-elementor-addons' ),
					'30min' => __( '30 Minutes', 'codexse-elementor-addons' ),
					'60min' => __( '60 Minutes', 'codexse-elementor-addons' ),
					'' => __( 'All', 'codexse-elementor-addons' ),
				],
				'default' => '15min'
			]
		);
		...
		$this->add_control(
			'event_type_details',
			[
				'label'        => __( 'Hide Event Type Details', 'codexse-elementor-addons' ),
	...
	protected function register_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' => sprintf(
					__( 'The following color customization controls only work with %s. Basic and Premium plan users cannot customize colors as per Calendy pricing plan. For more information please %s.', 'codexse-elementor-addons' ),
		...
		$this->add_control(
			'button_link_color',
			[
				'label' => __( 'Button & Link Color', 'codexse-elementor-addons' ),
				'type'  => Controls_Manager::COLOR,
			]
		);
