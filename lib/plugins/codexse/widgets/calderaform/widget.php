...
class CalderaForm extends Base {
    ...
    public function get_title() {
        return __( 'Caldera Forms', 'codexse-elementor-addons' );
    }

    public function get_custom_help_url() {
        return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/caldera-forms/';
    }
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_calderaf',
			[
				'label' => cx_is_calderaforms_activated() ? __( 'Caldera Forms', 'codexse-elementor-addons' ) : __( 'Missing Notice', 'codexse-elementor-addons' ),
			]
		);
        ...
        if ( ! cx_is_calderaforms_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'options' => ['' => __( '', 'codexse-elementor-addons' ) ] + \cx_get_caldera_form(),
				]
			);
    ...
    protected function render() {
        if ( ! cx_is_calderaforms_activated() ) {
			cx_show_plugin_missing_alert( __( 'Caldera Form', 'codexse-elementor-addons' ) );
            return;
        }
        ...
        if ( ! empty( $settings['form_id'] ) ) {
            echo cx_do_shortcode( 'caldera_form', [
                'id' => $settings['form_id'],
            ] );
		}
    }
