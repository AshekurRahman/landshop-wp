...
class Taxonomy_List extends Base {
	...
	public function get_title() {
		return __( 'Taxonomy List', 'codexse-elementor-addons' );
	}

	public function get_custom_help_url() {
		return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/taxonomy-list/';
	}
	...
	public static function get_taxonomies( $taxonomy_type = '' ) {
		$list = [];
		if ( $taxonomy_type ) {
			$tax = cx_get_taxonomies( [ 'public' => true, "object_type" => [ $taxonomy_type ] ], 'object', true );
		...
		foreach ( $this->get_taxonomies() as $key => $value ) {
			...
			$repeater[$key]->add_control(
				...
				[
					...
					'description' => __( 'If you want to use individual icon disable common icon.', 'codexse-elementor-addons' ),
					'options' => [
						'icon' => [
	...
	protected function __settings_content_controls() {
		...
		$this->add_control(
			'common_icon_enable',
			[
				'label' => __( 'Common icon enable?', 'codexse-elementor-addons' ),
				'description' => __( 'Common icon will overwrite all individual icon.', 'codexse-elementor-addons' ),
		...
		$this->add_control(
			'common_icon',
			[
				'label' => __( 'Common Icon', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'icon' => [
						'title' => __( 'Icon', 'codexse-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Icon', 'codexse-elementor-addons' ),
				'description' => __( 'Common icon will overwrite individual icon.', 'codexse-elementor-addons' ),
				'show_label' => false,
				'type' => Controls_Manager::ICONS,
				'default' => [
					'value' => 'far fa-check-circle',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item a' => '{{VALUE}};'
				],
				'condition' => [
					'view' => 'list',
				]
	...
	protected function __list_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item:first-child' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'advance_style' => 'yes',
				]
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Border', 'codexse-elementor-addons' ),
				'selector' => '{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item:first-child',
				'condition' => [
					'advance_style' => 'yes',
				]
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item:last-child' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'advance_style' => 'yes',
				]
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Border', 'codexse-elementor-addons' ),
				'selector' => '{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item:last-child',
				'condition' => [
					'advance_style' => 'yes',
				]
			]
	...
	protected function __title_style_controls() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cx-taxonomy-list-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#333333',
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list-title' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list .cx-taxonomy-list-item a:hover .cx-taxonomy-list-title' => 'color: {{VALUE}}',
				],
			]
		);
		$this->end_controls_tab();
	...
	protected function __icon_image_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '#333333',
				'selectors' => [
					'{{WRAPPER}} span.cx-taxonomy-list-icon' => 'color: {{VALUE}};',
					'{{WRAPPER}} span.cx-taxonomy-list-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} span.cx-taxonomy-list-icon' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'icon_line_height',
			[
				'label' => __( 'Icon Line Height', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} span.cx-taxonomy-list-icon' => 'line-height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list-image img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cx-taxonomy-list-image img',
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'image_boder',
				'label' => __( 'Border', 'codexse-elementor-addons' ),
				'selector' => '{{WRAPPER}} .cx-taxonomy-list-item a img',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .cx-taxonomy-list-image img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} span.cx-taxonomy-list-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} span.cx-taxonomy-list-image' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', [ 'cx-taxonomy-list-wrapper' ] );
		$this->add_render_attribute( 'wrapper-inner', 'class', [ 'cx-taxonomy-list' ] );
		if ( 'inline' === $settings['view'] ) {
			$this->add_render_attribute( 'wrapper-inner', 'class', [ 'cx-taxonomy-list-inline' ] );
		}
		$this->add_render_attribute( 'item', 'class', [ 'cx-taxonomy-list-item' ] );
					...
					<li <?php $this->print_render_attribute_string( 'item' ); ?>>
						<a href="<?php echo esc_url( get_term_link( $terms[$index]->term_id ) ); ?>">
							...
							<?php if ( $icon_settings ) :
								echo '<span class="cx-taxonomy-list-' . esc_attr( $icon_settings ) . '">';
