...
class Post_Info extends Base {
	...
	public function get_title() {
		return __( 'Post Info', 'codexse-elementor-addons' );
	}
	...
	protected function __post_meta_content_controls() {
		$this->start_controls_section(
			'_section_post_meta',
			[
				'label' => __( 'Meta Data', 'codexse-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => __( 'Default', 'codexse-elementor-addons' ),
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'time' => __( 'Time', 'codexse-elementor-addons' ),
					'comments' => __( 'Comments', 'codexse-elementor-addons' ),
					'terms' => __( 'Terms', 'codexse-elementor-addons' ),
		...
		$repeater->add_control(
			'date_format',
			[
				'label' => __( 'Date Format', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default' => 'Default',
					'0' => _x( 'March 6, 2018 (F j, Y)', 'Date Format', 'codexse-elementor-addons' ),
					'1' => '2018-03-06 (Y-m-d)',
					'2' => '03/06/2018 (m/d/Y)',
					'3' => '06/03/2018 (d/m/Y)',
					'custom' => __( 'Custom', 'codexse-elementor-addons' ),
		...
		$repeater->add_control(
			'custom_date_format',
			[
				'label' => __( 'Custom Date Format', 'codexse-elementor-addons' ),
				...
				'description' => sprintf(
					...
					__( 'Use the letters: %s', 'codexse-elementor-addons' ),
		...
		$repeater->add_control(
			'time_format',
			[
				'label' => __( 'Time Format', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default' => 'Default',
		...
		$repeater->add_control(
			'custom_time_format',
			[
				'label' => __( 'Custom Time Format', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'g:i a',
				'placeholder' => 'g:i a',
				'condition' => [
		...
		$repeater->add_control(
			'taxonomy',
			[
				'label' => __( 'Taxonomy', 'codexse-elementor-addons' ),
		...
		$repeater->add_control(
			'text_prefix',
			[
				'label' => __( 'Before', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
					'type!' => 'custom',
				],
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .cx-icon-list-icon' => 'width: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'show_avatar' => 'yes',
				],
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Custom Format', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => false,
				'condition' => [
					'type' => 'comments',
		...
		$repeater->add_control(
			'string_no_comments',
			[
				'label' => __( 'No Comments', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'No Comments', 'codexse-elementor-addons' ),
				'condition' => [
		...
		$repeater->add_control(
			'string_one_comment',
			[
				'label' => __( 'One Comment', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( 'One Comment', 'codexse-elementor-addons' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			'string_comments',
			[
				'label' => __( 'Comments', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => __( '%s Comments', 'codexse-elementor-addons' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			'custom_text',
			[
				'label' => __( 'Custom', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			'custom_url',
			[
				'label' => __( 'Custom URL', 'codexse-elementor-addons' ),
		...
		$repeater->add_control(
			'selected_icon',
			[
				'label' => __( 'Choose Icon', 'codexse-elementor-addons' ),
	...
	protected function __list_style_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-items:not(.cx-inline-items) .cx-icon-list-item:not(:last-child)' => 'padding-bottom: calc({{SIZE}}{{UNIT}}/2)',
					'{{WRAPPER}} .cx-icon-list-items:not(.cx-inline-items) .cx-icon-list-item:not(:first-child)' => 'margin-top: calc({{SIZE}}{{UNIT}}/2)',
					'{{WRAPPER}} .cx-icon-list-items.cx-inline-items .cx-icon-list-item' => 'margin-right: calc({{SIZE}}{{UNIT}}/2); margin-left: calc({{SIZE}}{{UNIT}}/2)',
					'{{WRAPPER}} .cx-icon-list-items.cx-inline-items' => 'margin-right: calc(-{{SIZE}}{{UNIT}}/2); margin-left: calc(-{{SIZE}}{{UNIT}}/2)',
					'{{WRAPPER}} .cx-icon-list-items.cx-inline-items .cx-icon-list-item::after' => 'margin-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'flex-start' => [
						'title' => __( 'Start', 'codexse-elementor-addons' ),
					...
					'flex-end' => [
						'title' => __( 'End', 'codexse-elementor-addons' ),
						'icon' => 'eicon-h-align-right',
					],
				],
				'selectors' => [
					'{{WRAPPER}} ul.cx-inline-items.cx-icon-list-items' => 'justify-content:{{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-item:not(:last-child):after' => 'content: ""',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-items:not(.cx-inline-items) .cx-icon-list-item:not(:last-child):after' => 'border-top-style: {{VALUE}};',
					'{{WRAPPER}} .cx-icon-list-items.cx-inline-items .cx-icon-list-item:not(:last-child):after' => 'border-left-style: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			'divider_weight',
			[
				'label' => __( 'Weight', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
				...
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-items:not(.cx-inline-items) .cx-icon-list-item:not(:last-child):after' => 'border-top-width: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .cx-inline-items .cx-icon-list-item:not(:last-child):after' => 'border-left-width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-item:not(:last-child):after' => 'width: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-item:not(:last-child):after' => 'height: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-item:not(:last-child):after' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	protected function __icon_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .cx-icon-list-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-icon' => 'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .cx-icon-list-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .cx-icon-list-icon svg' => '--e-icon-list-icon-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function __text_style_controls(){
		...
		$this->add_control(
			'text_indent',
			[
				'label' => __( 'Indent', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
				...
				'selectors' => [
					'body:not(.rtl) {{WRAPPER}} .cx-icon-list-text' => 'padding-left: {{SIZE}}{{UNIT}}',
					'body.rtl {{WRAPPER}} .cx-icon-list-text' => 'padding-right: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .cx-icon-list-text, {{WRAPPER}} .cx-icon-list-text a' => 'color: {{VALUE}}',
				]
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cx-icon-list-item',
			]
		);
	...
	protected function get_taxonomies() {
		...
		$options = [
			'' => __( 'Choose', 'codexse-elementor-addons' ),
		];
	...
	protected function get_meta_data( $repeater_item ) {
		...
		switch ( $repeater_item['type'] ) {
			...
			case 'comments':
				if ( comments_open() ) {
					$default_strings = [
						'string_no_comments' => __( 'No Comments', 'codexse-elementor-addons' ),
						'string_one_comment' => __( 'One Comment', 'codexse-elementor-addons' ),
						'string_comments' => __( '%s Comments', 'codexse-elementor-addons' ),
					];
					...
					if ( 0 === $num_comments ) {
						...
						$item_data['text'] = sprintf( _n( $default_strings['string_one_comment'], $default_strings['string_comments'], $num_comments, 'codexse-elementor-addons' ), $num_comments );
					}
	...
	protected function render_item( $repeater_item ) {
		...
		if ( 'inline' === $active_settings['view'] ) {
			$this->add_render_attribute( $item_key, 'class', 'cx-inline-item' );
		}
	...
	protected function render_item_icon_or_image( $item_data, $repeater_item, $repeater_index ) {
		...
		if ( ! empty( $item_data['image'] ) || $show_icon ) {
			...
			if ( ! empty( $item_data['image'] ) ) :
				...
				?>
					<img class="cx-avatar" <?php echo $this->get_render_attribute_string( $image_data ); ?>>
	...
	protected function render_item_text( $item_data, $repeater_index ) {
		...
		$this->add_render_attribute( $repeater_setting_key, 'class', [ 'cx-icon-list-text', 'cx-post-info__item', 'cx-post-info__item--type-' . $item_data['type'] ] );
		if ( ! empty( $item['terms_list'] ) ) {
			$this->add_render_attribute( $repeater_setting_key, 'class', 'cx-terms-list' );
		}

		?>
		<span <?php echo $this->get_render_attribute_string( $repeater_setting_key ); ?>>
			<?php if ( ! empty( $item_data['text_prefix'] ) ) : ?>
				<span class="cx-post-info__item-prefix"><?php echo esc_html( $item_data['text_prefix'] ); ?></span>
			<?php endif; ?>
			<?php
			if ( ! empty( $item_data['terms_list'] ) ) :
				$terms_list = [];
				$item_class = 'cx-post-info__terms-list-item';
				?>
				<span class="cx-post-info__terms-list">
				<?php
	...
	protected function render() {
		...
		if ( 'inline' === $settings['view'] ) {
			$this->add_render_attribute( 'icon_list', 'class', 'cx-inline-items' );
		}

		$this->add_render_attribute( 'icon_list', 'class', [ 'cx-icon-list-items', 'cx-post-info' ] );
		?>
