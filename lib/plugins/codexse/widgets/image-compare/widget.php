...
class Image_Compare extends Base {
    ...
    public function get_title() {
        return __( 'Image Compare', 'codexse-elementor-addons' );
    }

	public function get_custom_help_url() {
		return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/image-compare/';
	}
	...
	protected function __image_content_controls() {
		...
		$this->start_controls_section(
			'_section_images',
			[
				'label' => __( 'Images', 'codexse-elementor-addons' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Before', 'codexse-elementor-addons' ),
                'placeholder' => __( 'Type before image label', 'codexse-elementor-addons' ),
                'description' => __( 'Label will not be shown if Hide Overlay is enabled in Settings', 'codexse-elementor-addons' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->start_controls_tab(
            '_tab_after_image',
            [
                'label' => __( 'After', 'codexse-elementor-addons' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Label', 'codexse-elementor-addons' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'After', 'codexse-elementor-addons' ),
                'placeholder' => __( 'Type after image label', 'codexse-elementor-addons' ),
                'description' => __( 'Label will not be shown if Hide Overlay is enabled in Settings', 'codexse-elementor-addons' ),
                'dynamic' => [
                    'active' => true,
                ]
	...
	protected function __settings_content_controls() {
        ...
        $this->add_control(
            'offset',
            [
                'label' => __( 'Visibility Ratio', 'codexse-elementor-addons' ),
        ...
        $this->add_control(
            'orientation',
            [
                'label' => __( 'Orientation', 'codexse-elementor-addons' ),
        ...
        $this->add_control(
            'hide_overlay',
            [
                'label' => __( 'Hide Overlay', 'codexse-elementor-addons' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Yes', 'codexse-elementor-addons' ),
                'label_off' => __( 'No', 'codexse-elementor-addons' ),
                'return_value' => 'yes',
                'description' => __( 'Hide overlay with before and after label', 'codexse-elementor-addons' ),
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            'move_handle',
            [
                'label' => __( 'Move Handle', 'codexse-elementor-addons' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'on_swipe',
                'options' => [
                    'on_hover' => __( 'On Hover', 'codexse-elementor-addons' ),
                    'on_click' => __( 'On Click', 'codexse-elementor-addons' ),
                    'on_swipe' => __( 'On Swipe', 'codexse-elementor-addons' ),
                ],
                'description' => __( 'Select handle movement type. Note: overlay does not work with On Hover.', 'codexse-elementor-addons' ),
                'style_transfer' => true,
            ]
        );
    ...
    protected function __handle_style_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Handle', 'codexse-elementor-addons' ),
        ...
        $this->add_control(
            '_heading_bar',
            [
                'label' => __( 'Handle Bar', 'codexse-elementor-addons' ),
        ...
        $this->add_control(
            '_heading_arrow',
            [
                'label' => __( 'Handle Arrow', 'codexse-elementor-addons' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            'arrow_box_height',
            [
                'label' => __( 'Box Height', 'codexse-elementor-addons' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
    ...
    protected static function get_data_settings( $settings ) {
        ...
        return cx_prepare_data_prop_settings( $settings, $field_map );
    }
	...
	protected function render() {
        ...
        $this->add_render_attribute( 'container', 'data-codexse-settings', self::get_data_settings( $settings ) );
        ?>
    ...
    public function content_template() {
        ...
        view.addRenderAttribute('container', 'data-codexse-settings', JSON.stringify(data)); #>
