...
class Slider extends Base {
	...
	public function get_title() {
		return __( 'Slider', 'codexse-elementor-addons' );
	}

	public function get_custom_help_url() {
		return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/slider/';
	}
	...
	protected function __slider_item_style_controls() {
		...
		$this->start_controls_section(
			'_section_style_item',
			[
				'label' => __( 'Slider Item', 'codexse-elementor-addons' ),
		...
		$this->add_group_control(
			...
			[
				'name' => 'item_border',
				'selector' => '{{WRAPPER}} .cx-slick-item',
			]
		);
	...
	protected function render() {
		...
		<div class="hajs-slick cx-slick cx-slick--slider">
