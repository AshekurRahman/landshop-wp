...
class CF7 extends Base {
    ...
    public function get_title() {
        return __( 'Contact Form 7', 'codexse-elementor-addons' );
    }

	public function get_custom_help_url() {
		return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/contact-7-form/';
	}
	...
	protected function register_content_controls() {
		...
		$this->start_controls_section(
			'_section_cf7',
			[
				'label' => cx_is_cf7_activated() ? __( 'Contact Form 7', 'codexse-elementor-addons' ) : __( 'Missing Notice', 'codexse-elementor-addons' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);

        if ( ! cx_is_cf7_activated() ) {
			...
			$this->add_control(
				...
				[
					...
					'label_block' => true,
					'options' => ['' => __( '', 'codexse-elementor-addons' ) ] + \cx_get_cf7_forms(),
				]
			);
			...
			$this->add_control(
				'html_class',
				[
					'label' => __( 'HTML Class', 'codexse-elementor-addons' ),
					'type' => Controls_Manager::TEXT,
					'label_block' => true,
					'description' => __( 'Add CSS custom class to the form.', 'codexse-elementor-addons' ),
				]
			);
    ...
    protected function __fields_style_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .cx-cf7-form label' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'field_margin',
            [
                'label' => __( 'Spacing Bottom', 'codexse-elementor-addons' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Placeholder Text Color', 'codexse-elementor-addons' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render() {
        if ( ! cx_is_cf7_activated() ) {
			cx_show_plugin_missing_alert(__( 'Contact Forms 7', 'codexse-elementor-addons' ) );
            return;
        }
        ...
        if ( ! empty( $settings['form_id'] ) ) {
            echo cx_do_shortcode( 'contact-form-7', [
                'id' => $settings['form_id'],
                'html_class' => 'cx-cf7-form ' . cx_sanitize_html_class_param( $settings['html_class'] ),
			] );
        }
    }
}
