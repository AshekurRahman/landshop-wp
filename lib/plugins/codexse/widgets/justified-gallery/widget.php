...
class Justified_Gallery extends Base {
	...
	public function get_title() {
		return __( 'Justified Grid', 'codexse-elementor-addons' );
	}

	public function get_custom_help_url() {
		return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/justified-grid/';
	}
	...
	protected function __advance_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'return_value' => 'yes',
				'separator' => 'before',
				'description' => __( 'Make sure to add image caption.', 'codexse-elementor-addons' ),
				'style_transfer' => true,
		...
		$this->add_control(
			'max_row_height',
			[
				'label' => __( 'Max row height enable?', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'codexse-elementor-addons' ),
				'label_off' => __( 'No', 'codexse-elementor-addons' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'margins',
			[
				'label' => __( 'Margins', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'default' => [
					'size' => 10,
				...
				'render_type' => 'ui',
				'selectors' => [
					'{{WRAPPER}} .cx-justified-grid__wrap' => '--justified-grid-pull: {{SIZE}}{{UNIT}};'
				]
			]
		);
		...
		$this->add_control(
			'last_row',
			[
				'label' => __( 'Last Row', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'justify',
				'options' => [
					'nojustify' => __( 'No Justify', 'codexse-elementor-addons' ),
					'justify' => __( 'Justify', 'codexse-elementor-addons' ),
					'hide' => __( 'Hide', 'codexse-elementor-addons' ),
				],
				'frontend_available' => true,
				'render_type' => 'ui',
			]
	...
	protected function __image_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .cx-justified-grid__item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-justified-grid__item' => 'background-color: {{VALUE}};'
				 ]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-justified-grid__item img' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cx-justified-grid__item img',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-justified-grid__item:hover img' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cx-justified-grid__item:hover img',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-justified-grid__item img' => 'transition-duration: {{SIZE}}s;',
				],
			]
		);
		...
		$this->add_control(
			'image_hover_cursor',
			[
				'label' => __( 'Hover Cursor', 'codexse-elementor-addons' ),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'options' => cx_get_css_cursors(),
				'default' => 'default',
				'selectors' => [
					'{{WRAPPER}} .cx-justified-grid__item:hover img' => 'cursor: {{VALUE}};'
				]
			]
		);
	...
	protected function __caption_style_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Caption', 'codexse-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .justified-gallery > .cx-justified-grid__item > .caption' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .justified-gallery > .cx-justified-grid__item > .caption' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .justified-gallery > .cx-justified-grid__item > .caption' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .justified-gallery > .cx-justified-grid__item > .caption',
				'global' => [
	...
	protected function __filter_menu_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .cx-filter__item--active' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .cx-filter__item--active' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .cx-filter__item--active' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div <?php echo $this->get_render_attribute_string( 'grid_wrap' ); ?>>
			<?php foreach ( $gallery['items'] as $id => $filter_str ) :
				...
				?>
				<<?php echo $item_html_tag; ?> <?php echo $popup; ?> class="cx-justified-grid__item cx-js-lightbox <?php echo esc_attr( $filter_str ); ?>" title="<?php echo $caption; ?>">
