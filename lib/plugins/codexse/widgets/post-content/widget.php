...
class Post_Content extends Base {
	...
	public function get_title() {
		return __( 'Post Content', 'codexse-elementor-addons' );
	}

	public function get_custom_help_url() {
		return 'https://codexseaddons.com/docs/codexse-addons-for-elementor/widgets/post-content/';
	}
	...
	protected function __post_content_control(){
		$this->start_controls_section(
			...
			[
				'label' => __( 'Post Content', 'codexse-elementor-addons' ),
