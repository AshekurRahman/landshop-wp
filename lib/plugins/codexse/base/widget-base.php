...
abstract class Base extends Widget_Base {
    ...
    public function get_categories() {
        return ['codexse_addons_category'];
    }
    ...
    protected function register_controls() {
        do_action( 'codexseaddons_start_register_controls', $this );

        $this->register_content_controls();

		do_action( 'codexseaddons_after_register_content_controls', $this );

        $this->register_style_controls();

        do_action('codexseaddons_end_register_controls', $this);
    }
    ...
    protected function render_edit_tools() {
        if (cx_is_elementor_version('<=', '2.5.16')) {
    ...
    public function add_link_attributes($element, array $url_control, $overwrite = false) {
         ...
         */
        if (cx_is_elementor_version('>=', '2.8.0')) {
