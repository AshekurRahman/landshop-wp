...
trait Creative_Button_Markup {
    ...
    public function render_estilo_markup($settings) {
        $this->add_render_attribute( 'wrap', 'class', 'cx-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'cx-creative-btn', 'cx-stl--' . $settings['btn_style'], 'cx-eft--' .$settings['estilo_effect'] ] );
...
EOF;
    ...
    public function render_symbolab_markup($settings){
        $this->add_render_attribute( 'wrap', 'class', 'cx-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'cx-creative-btn', 'cx-stl--' . $settings['btn_style'], 'cx-eft--' .$settings['symbolab_effect'] ] );
...
EOF;
    ...
    public function render_iconica_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'cx-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'cx-creative-btn', 'cx-stl--' . $settings['btn_style'], 'cx-eft--' .$settings['iconica_effect'] ] );
...
EOF;
    ...
    public function render_montino_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'cx-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'cx-creative-btn', 'cx-stl--' . $settings['btn_style'], 'cx-eft--' .$settings['montino_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
...
EOF;
    ...
    public function render_hermosa_markup($settings){
		$this->add_render_attribute( 'wrap', 'class', 'cx-creative-btn-wrap' );
        $this->add_render_attribute( 'button', 'class', [ 'cx-creative-btn', 'cx-stl--' . $settings['btn_style'], 'cx-eft--' .$settings['hermosa_effect'] ] );
        $this->add_link_attributes( 'button', $settings['button_link'] );
