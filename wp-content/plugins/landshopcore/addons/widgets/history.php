...
class landshop_history_widget extends Widget_Base {

    public function get_name() {
        return 'landshop-history-widget';
    }
    
    public function get_title() {
        return __( 'History', 'landshopcore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'landshop_history_content_section',
            [
                'label' => __( 'History', 'landshopcore' ),
            ]
        );
            ...
            $this->add_control(
                ...
                [
				    ...
				    'label' => esc_html__( 'history Items', 'landshopcore' ),
    ...
    protected function render( $instance = [] ) {
        ...
        if($settings['history_list']){
            ...
            esc_html_e('Please make a history! It is empty.','landshopcore');
        }
        echo '</div>';        
    }
}
Plugin::instance()->widgets_manager->register_widget_type( new landshop_history_widget );
