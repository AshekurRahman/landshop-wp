...
class landshop_service_widget extends Widget_Base {

    public function get_name() {
        return 'landshop-service-widget';
    }
    
    public function get_title() {
        return __( 'Service', 'landshopcore' );
    }

    public function get_icon() {
        return 'landshop-icon eicon-slider-device';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'landshop_service_content_section',
            [
                'label' => __( 'Service', 'landshopcore' ),
            ]
        );
            ...
            $repeater->add_control(
                'icon_type',
                [
                    'label' => __('Thumbnail Type','landshopcore'),
                    'type' =>Controls_Manager::CHOOSE,
                    'options' =>[
                        'img' =>[
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => __('Link Building','landshopcore'),
                ]
            );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => __('Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim.','landshopcore'),
                ]
            );
            ...
            $this->add_control(
                ...
                [
				    ...
				    'label' => esc_html__( 'Service Items', 'landshopcore' ),
                    'type' => Controls_Manager::REPEATER,
                    'fields' => $repeater->get_controls(),
                    'default' => [
                        [
                            'box_title'           => __('Link Building','landshopcore'),
                            'box_desc'    => __( 'Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim.','landshopcore' ),
                        ],
                        [
                            'box_title'           => __('Link Building','landshopcore'),
                            'box_desc'    => __( 'Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim.','landshopcore' ),
        ...
        $this->start_controls_section(
            'landshop_feature_style_section',
            [
    ...
    protected function render( $instance = [] ) {
        ...
        if($settings['service_list']){
                            ...
                            echo '<div class="swiper-slide">';
                                echo '<div class="service-box">';
                                    if( $value['icon_type'] == 'img' and !empty(Group_Control_Image_Size::get_attachment_image_html( $value, 'icon_imagesize', 'icon_image' )) ){
                                        ...
                                        echo sprintf( '<div class="box-icon" >%1$s</div>', landshop_icon_manager::render_icon( $value['icon_font'], [ 'aria-hidden' => 'true' ] ) );
                                    }
            ...
            esc_html_e('Please make a service! It is empty.','landshopcore');
        }
        echo '</div>';        
    }
}
Plugin::instance()->widgets_manager->register_widget_type( new landshop_service_widget );
