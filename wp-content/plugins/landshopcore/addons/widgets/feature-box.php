...
class landshop_feature_Box extends Widget_Base{
	...
	public function get_title(){
		return __( 'Feature Box','landshopcore' );
	}
	...
	public function get_icon() {
		return 'landshop-icon eicon-icon-box';
	}
    ...
    protected function  register_controls(){
        $this->start_controls_section(
            'feature_box',
            [
                'label' => __( 'Feature Box', 'landshopcore' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Features Title', 'landshopcore' ),
            ]
        );        
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Enter type your description...', 'landshopcore' ),
            ]
        );
		...
		$this->add_control(
			'read_switch',
			[
				'label' => __( 'Read More Button', 'landshopcore' ),
        ...
        $this->add_control(
            'button_icon_type',
            [
                'label' => __('Button Icon Type','landshopcore'),
                'type' =>Controls_Manager::CHOOSE,
                'options' =>[
                    'img' =>[
                        'title' =>__('Image','landshopcore'),
        ...
        $this->start_controls_tab( 'box_title_hover_tab',
			[
				'label' => __( 'Box Hover', 'landshopcore' ),
			]
		);        
    ...
    protected function render() {       
        ...
        $this->add_render_attribute( 'landshop_feature_attr', 'class', 'feature-box' );            
        
        $html_output = '';
        $html_output .= '<div '.$this->get_render_attribute_string( 'landshop_feature_attr' ).' >';        
        if( $settings['icon_type'] == 'img' and !empty(Group_Control_Image_Size::get_attachment_image_html( $settings, 'imagesize', 'image' )) ){
            ...
            $html_output .= sprintf( '<div class="feature-icon" >%1$s</div>', landshop_icon_manager::render_icon( $settings['feature_icon'], [ 'aria-hidden' => 'true' ] ) );
        ...
        if ( $settings['read_switch'] == 'yes' ) {            
            ...
            $html_output .= '<a '.$this->get_render_attribute_string( 'url' ).' >';
                if( $settings['button_icon_type'] == 'img' and !empty(Group_Control_Image_Size::get_attachment_image_html( $settings, 'button_imagesize', 'button_image' )) ){
                    ...
                    $html_output .= sprintf( '<span class="icon" >%1$s</span>', landshop_icon_manager::render_icon( $settings['button_icon'], [ 'aria-hidden' => 'true' ] ) );
...
Plugin::instance()->widgets_manager->register_widget_type( new landshop_feature_Box );