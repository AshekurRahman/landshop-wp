...
/**
 * landshopcore shortcode-form widget.
 *
 * landshopcore widget that displays a shortcode-form with the ability to control every
 * aspect of the shortcode-form design.
 *
 * @since 1.0.0
 */
class landshop_Subscribe_Form extends Widget_Base {
	/**
	 * Get widget name.
	 *
    ...
    public function get_name() {
        return 'landshop_Subscribe_Form';
    }
	...
	public function get_title() {
		return __( 'Form Shortcode', 'landshopcore' );
	}
	...
	public function get_icon() {
		return 'landshop-icon eicon-shortcode';
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Subscribe Form', 'landshopcore' ),
			]
		);
        ...
        $this->add_control(
			'shortcode_box',
			[
				'label' => __( 'Shortcode', 'landshopcore' ),
				'type' => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
				'description' => __( 'Please enter MailChimp form Shortcode.','landshopcore' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __( 'Lavel Custom CSS', 'landshopcore' ),
        ...
        $this->start_controls_section(
			'input_style_section',
			[
				'label' => __( 'Input Field', 'landshopcore' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => __( 'focus Background', 'landshopcore' ),
				'types' => [ 'classic', 'gradient' ],
		...
		$this->end_controls_tabs();
            ...
            'custom_input_css',
            [
                'label' => __( 'Input Field CSS', 'landshopcore' ),
                'type' => Controls_Manager::CODE,
				'rows' => 20,
                'language' => 'css',
                'selectors' => [
        ...
        $this->add_responsive_control(
         ...
         $this->add_responsive_control(
            'button_floting',
            [
                'label' => __( 'Button Floating', 'landshopcore' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
   ...
   <div class="shortcode-form">
        <?php
            if( $settings['icon_type'] == 'img' and !empty(Group_Control_Image_Size::get_attachment_image_html( $settings, 'icon_imagesize', 'icon_image' )) ){
                ...
                echo sprintf( '<div class="x-icon" >%1$s</div>', landshop_icon_manager::render_icon( $settings['title_icon'], [ 'aria-hidden' => 'true' ] ) );
            }
        ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new landshop_Subscribe_Form );