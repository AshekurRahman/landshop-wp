...
class landshop_Core_Floting_Effect {
    ...
    public function add_floating_effect_controls( Element_Base $element ) {
        $element->add_control(
            'ha_floating_fx',
            [
                'label' => __( 'Movement Effects', 'landshopcore' ),
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Translate', 'landshopcore' ),
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Translate X', 'landshopcore' ),
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Translate Y', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%', 'vw' ],
                'range' => [
                    'px' => [
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Duration', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Rotate X', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Rotate Y', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Rotate Z', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
...
landshop_Core_Floting_Effect::instance()->init();