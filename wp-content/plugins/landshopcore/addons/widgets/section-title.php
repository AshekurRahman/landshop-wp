...
class landshop_Elementor_Widget_Section_Title extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Section Title', 'landshopcore' );
    }

    public function get_icon() {
        return 'landshop-icon eicon-animation-text';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Top Heading','landshopcore' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Top Heading Here.', 'landshopcore' ),
                'placeholder' => __( 'Type your top title here', 'landshopcore' ),
            ]
        );
        ...
        $this->add_control(
            'top_heading_tag',
            [
                'label' => __( 'HTML Tag', 'landshopcore' ),
                'type' => Controls_Manager::SELECT,
                'options' => landshop_html_tag_lists(),
                'default' => 'h5',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Main Heading','landshopcore' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Main Heading Here.', 'landshopcore' ),
                'placeholder' => __( 'Type your main title here', 'landshopcore' ),
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Sub Heading','landshopcore' ),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Sub Heading', 'landshopcore' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Sub Heading Here.', 'landshopcore' ),
                'placeholder' => __( 'Type your sub title here', 'landshopcore' ),
            ]
        );
        $this->add_control(
            'sub_heading_tag',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Description', 'landshopcore' ),
                'type' => Controls_Manager::WYSIWYG,
                'default' => __( 'Description Content Here.', 'landshopcore' ),
                'placeholder' => __( 'Type your description here', 'landshopcore' ),
            ]
        );
        $this->add_control(
            'desc_tag',
        ...
        $this->add_responsive_control(
            'icon_width',
            [
                'label' => __( 'Icon Width', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'icon_height',
            [
                'label' => __( 'Icon Height', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'icon_hr_offset',
            [
                'label' => __( 'Horizontal Offset', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [  'px', '%', 'vw' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'icon_vr_offset',
            [
                'label' => __( 'Vertical Offset', 'landshopcore' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [  'px', '%', 'vh' ],
                'range' => [
                    'px' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .landshop-section-heading' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .landshop-section-heading' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' =>'before',
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .landshop-section-heading',
                ]
            );
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .landshop-section-heading' => 'display: flex; flex-direction: column;  {{VALUE}}',
                    ],
                ]
            );
            $this->add_group_control(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .landshop-section-heading' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ]
                ]
            );
            $this->add_group_control(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .landshop-section-heading' => 'transform: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .landshop-section-heading' => 'transition-duration: {{SIZE}}s',
                    ],
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'landshopcore' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .landshop-section-heading:hover',
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::DIMENSIONS,
                    'selectors' => [
                        '{{WRAPPER}} .landshop-section-heading:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                    ],
                ]
            );
            $this->add_group_control(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => 'translateY(0)',
                    'selectors' => [
                        '{{WRAPPER}} .landshop-section-heading:hover' => 'transform: {{VALUE}}',
                    ],
                ]
            );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .landshop-section-heading .top-heading',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .top-heading' => 'color: {{VALUE}};',
                ],
            ]
        );               
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .top-heading' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );
        ...
        $this->add_responsive_control(
          ...
          [
            ...
            'size_units' => [ 'px', '%', 'vw' ],
            'selectors' => [
              '{{WRAPPER}} .landshop-section-heading .top-heading' => 'width: {{SIZE}}{{UNIT}};max-width: 100%;display: inline-block;',
            ],
          ]
        );        
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .landshop-section-heading .main-heading',
            ]
        );        
        $this->add_control(
            'main_heading_color',
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .main-heading' => 'color: {{VALUE}};',
                ],
            ]
        );               
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .main-heading' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .main-heading' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );   
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .landshop-section-heading .sub-heading',
            ]
        );        
        $this->add_control(
            'sub_heading_color',
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .sub-heading' => 'color: {{VALUE}};',
                ],
            ]
        );               
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .sub-heading' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );        
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .sub-heading' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );   
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'desc_typo',
                'selector' => '{{WRAPPER}} .landshop-section-heading .desc',
            ]
        );        
        $this->add_control(
            'desc_color',
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .desc' => 'color: {{VALUE}};',
                ],
            ]
        );               
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .desc' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );        
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .landshop-section-heading .desc' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'separator' =>'before',
            ]
        );   
    ...
    protected function render( $instance = [] ) {
        ...
        /*== Set-Area-Class ==*/
        $this->add_render_attribute( 'section_area_attr', 'class', 'landshop-section-heading' );
        ...
        if( $settings['icon_type'] == 'img' and !empty(Group_Control_Image_Size::get_attachment_image_html( $settings, 'imagesize', 'image' )) ){
            ...
            $html_output .= sprintf( '<div class="x-icon" >%1$s</div>', landshop_icon_manager::render_icon( $settings['title_icon'], [ 'aria-hidden' => 'true' ] ) );
        }
...
Plugin::instance()->widgets_manager->register_widget_type( new landshop_Elementor_Widget_Section_Title );