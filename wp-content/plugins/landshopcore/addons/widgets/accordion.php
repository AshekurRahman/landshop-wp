 ...
 * @since 1.0.0
 */
class landshopcore_Widget_Accordion extends Widget_Base {
	...
	public function get_title() {
		return __( 'Accordion', 'landshopcore' );
	}
	...
	public function get_icon() {
		return 'landshop-icon eicon-accordion';
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Accordion', 'landshopcore' ),
			]
		);
		...
		$repeater->add_control(
			'tab_title',
			[
				'label' => __( 'Title & Description', 'landshopcore' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Accordion Title', 'landshopcore' ),
				'dynamic' => [
					'active' => true,
				],
				'label_block' => true,
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Accordion Content', 'landshopcore' ),
				'opened_label' => false,
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => __( 'Accordion Items', 'landshopcore' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => __( 'Accordion #1', 'landshopcore' ),
						'tab_content' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'landshopcore' ),
					],
					[
						'tab_title' => __( 'Accordion #2', 'landshopcore' ),
						'tab_content' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'landshopcore' ),
					],
				],
		...
		$this->add_control(
			'title_html_tag',
			[
				'label' => __( 'Title HTML Tag', 'landshopcore' ),
        ...
        $this->add_control(
            'closed_icon_type',
            [
                'label' => __('Opened Icon','landshopcore'),
        ...
        $this->add_control(
            'opened_icon_type',
            [
                'label' => __('Closed Icon','landshopcore'),
                'type' =>Controls_Manager::CHOOSE,
                'options' =>[
                    'img' =>[
                        'title' =>__('Image','landshopcore'),
        ...
        $this->start_controls_section(
            'landshop_accordion_style_section',
            [
                ...
                <<?php echo $settings['title_html_tag']; ?> <?php echo $this->get_render_attribute_string( $tab_title_setting_key ); ?>>
                   ...
                   <?php 
                        if( $settings['closed_icon_type'] == 'img' and !empty(Group_Control_Image_Size::get_attachment_image_html( $settings, 'closed_icon_img_size', 'closed_icon_img' )) ){
                            ...
                            echo sprintf( '<span class="icon icon-closed" >%1$s</span>', landshop_icon_manager::render_icon( $settings['closed_font_icon'], [ 'aria-hidden' => 'true' ] ) );
                        }
                    ?>
                   <?php 
                        if( $settings['opened_icon_type'] == 'img' and !empty(Group_Control_Image_Size::get_attachment_image_html( $settings, 'opened_icon_img_size', 'opened_icon_img' )) ){
                            ...
                            echo sprintf( '<span class="icon icon-opened" >%1$s</span>', landshop_icon_manager::render_icon( $settings['opened_font_icon'], [ 'aria-hidden' => 'true' ] ) );
                        }
                    ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new landshopcore_Widget_Accordion );