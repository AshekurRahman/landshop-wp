 ...
 * @since 1.0.0
 */
class landshop_Cirlce_Progress extends Widget_Base {
	...
	public function get_title() {
		return __( 'Circle Progress', 'landshopcore' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_counter',
			[
				'label' => __( 'Circle Progress', 'landshopcore' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => '%',
				'placeholder' => __( 'Suffix', 'landshopcore' ),
			]
		);
		...
		$this->add_control(
			'trackColor',
			[
				'label' => __( 'Track Color', 'landshopcore' ),
				'type' => Controls_Manager::COLOR,
                'default' => '#C4EDF7',
			]
		);
		...
		$this->add_control(
			'scaleColor',
			[
				'label' => __( 'Scale Color', 'landshopcore' ),
				'type' => Controls_Manager::COLOR,
                'default' => '#dfe0e0',
			]
		);
		$this->add_control(
			'scaleLength',
			[
				'label' => __( 'Scale Length', 'landshopcore' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 0,
				'max' => 50,
				'min' => 0,
		...
		$this->add_control(
			'lineWidth',
			[
				'label' => __( 'Line Width', 'landshopcore' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 15,
				'max' => 50,
				'min' => 1,
        ...
        $this->add_control(
            'lineCap',
            [
                'label' => esc_html__( 'Line Cap', 'landshopcore' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'round',
                'options' => [
                    'round'  => esc_html__( 'Round', 'landshopcore' ),
                    'square'  => esc_html__( 'Square', 'landshopcore' ),
                    'butt'  => esc_html__( 'Butt', 'landshopcore' ),
                ],
            ]
        );
		$this->add_control(
...
Plugin::instance()->widgets_manager->register_widget_type( new landshop_Cirlce_Progress );