...
class landshop_Testimonial_Widget extends Widget_Base {

    public function get_name() {
        return 'landshop-testimonial-widget';
    }
    
    public function get_title() {
        return __( 'Testimonial', 'landshopcore' );
    }

    public function get_icon() {
        return 'landshop-icon eicon-testimonial-carousel';
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'landshop_testimonial_content_section',
            [
                'label' => __( 'Testimonial', 'landshopcore' ),
            ]
        );
            ...
            $this->add_control(
                'testimonial_style',
                [
                    'label' => esc_html__( 'Box Style', 'landshopcore' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 's1',
                    'options' => [
                        's1'  => __( 'One', 'landshopcore' ),
                        's2'  => __( 'Two', 'landshopcore' ),
                        's3'  => __( 'Three', 'landshopcore' ),
                        's4'  => __( 'Four', 'landshopcore' ),
                        's5'  => __( 'Five', 'landshopcore' ),
                    ],
                    'separator'=>'none',
                ]
            );
            ...
            $this->add_control(
                'slider_on',
                [
                    'label' => esc_html__( 'Slider', 'landshopcore' ),
            ...
            $repeater->add_control(
                'client_image',
                [
                    'label' => __( 'Client Photo', 'landshopcore' ),
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => __('Carolina Monntoya','landshopcore'),
                ]
            );
            ...
            $repeater->add_control(
                'client_designation',
                [
                    'label'   => __( 'Designation', 'landshopcore' ),
                    'type'    => Controls_Manager::TEXT,
                    'default' => __('Managing Director','landshopcore'),
                ]
            );
            ...
            $repeater->add_control(
                'client_say',
                [
                    'label'   => __( 'Client Said', 'landshopcore' ),
                    'type'    => Controls_Manager::TEXTAREA,
                    'default' => __('Massa eget egestas purus viverra accumsan in nisl nisi. Aliquam faucibus purus in massa nibh tellus tempor nec lorem','landshopcore'),
                ]
            );
            ...
            $repeater->add_control(
                'client_logo_image',
                [
                    'label' => __( 'Client Logo', 'landshopcore' ),
                    'type' => Controls_Manager::MEDIA,
                ]
            );
            ...
            $this->add_control(
                'landshop_testimonial_list',
                [
                    
				    'label' => esc_html__( 'Testimonial Items', 'landshopcore' ),
                    ...
                    'default' => [
                        [
                            'feed_rating'           => 4,
                            'client_name'           => __('Alex John','landshopcore'),
                            'client_designation'    => __( 'Voluntter','landshopcore' ),
                            'client_say'            => __( 'Massa eget egestas purus viverra accumsan in nisl nisi. Aliquam faucibus purus in massa nibh tellus tempor nec lorem', 'landshopcore' ),
                        ],
                        [
                            'feed_rating'           => 4,
                            'client_name'           => __('J ack lamps','landshopcore'),
                            'client_designation'    => __( 'Voluntter','landshopcore' ),
                            'client_say'            => __( 'Massa eget egestas purus viverra accumsan in nisl nisi. Aliquam faucibus purus in massa nibh tellus tempor nec lorem', 'landshopcore' ),
                        ],
                        [
                            'feed_rating'           => 4,
                            'client_name'           => __('Lona Shiro','landshopcore'),
                            'client_designation'    => __( 'Voluntter','landshopcore' ),
                            'client_say'            => __( 'Massa eget egestas purus viverra accumsan in nisl nisi. Aliquam faucibus purus in massa nibh tellus tempor nec lorem', 'landshopcore' ),
                        ],
                    ],
            ...
            $this->add_control(
                'quote_icon_type',
                [
                    'label' => __('Quote Icon Type','landshopcore'),
                    'type' =>Controls_Manager::CHOOSE,
                    'options' =>[
                        'img' =>[
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Client Say', 'landshopcore' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
            $this->add_control(
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Thumbnail', 'landshopcore' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
    ...
    protected function render( $instance = [] ) {
        ...
        if($settings['landshop_testimonial_list']){
            if( $settings['slider_on'] == 'yes' ) {                
                echo '<div '.$this->get_render_attribute_string( "wrapper_attributes" ).'  >';
                    echo '<div class="swiper-wrapper">';
                        foreach( $settings['landshop_testimonial_list'] as $items ):  
            ...
            esc_html_e('Please make a testimonial! It is empty.','landshopcore');
        }
        echo '</div>';        
    }
    ...
    protected function team_style4($items){
        ...
        echo '<div class="testimonial-box s4">';        
            if( $settings['quote_icon_type'] == 'img' and !empty(Group_Control_Image_Size::get_attachment_image_html( $settings, 'quote_imagesize', 'quote_image' )) ){
                ...
                echo sprintf( '<div class="quote" ><div class="quote" >%1$s</div></div>', landshop_icon_manager::render_icon( $settings['quote_icon'], [ 'aria-hidden' => 'true' ] ) );
            }        
...
Plugin::instance()->widgets_manager->register_widget_type( new landshop_Testimonial_Widget );
