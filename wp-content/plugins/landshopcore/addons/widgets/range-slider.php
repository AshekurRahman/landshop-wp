 ...
 * @since 1.0.0
 */
class landshop_Price_slider extends Widget_Base {
	/**
	 * Get widget name.
	 *
	...
	public function get_title() {
		return __( 'Range Slider', 'landshopcore' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_slider',
			[
				'label' => __( 'Range Slider', 'landshopcore' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'placeholder' => __( 'Symble', 'landshopcore' ),
			]
		);
        ...
        $this->add_control(
            'slider_color',
            [
                'label' => __( 'Slider Color', 'landshopcore' ),
        ...
        $this->add_control(
             'slider_target_id',
             [
                 'label'     => __( 'Price Table Connector ID', 'landshopcore' ),
                 'type'      => Controls_Manager::TEXT,
                 'title' => __( 'Copy this ID to use at your price table "Range Slider ID" field.', 'landshopcore' ),
                 'default' => uniqid(),
             ]
         );
...
Plugin::instance()->widgets_manager->register_widget_type( new landshop_Price_slider );