...
(function ($) {
    ...
    var AudioPlayerJS = function ($scope, $) {
        ...
        var nodeList = document.querySelectorAll('.landshopcore_player.landshopcore_audio');
    ...
    // Countdown
    var landshop_switch = function ($scope, $) {
        var switch_main = $scope.find('.landshop-switch-area');
        var switch_parent = $scope.find('.landshop-switches');
    ...
    var WidgetCountdownMapHandler = function ($scope, $) {
        ...
        if ( countdown_elem.length > 0 ) {
            countdown_elem.each(function () {
                ...
                $this.countdown(countdownoptions.landshopcoredate, function (event) {

                    var finalTime, daysTime, hours, minutes, second;

                    if( countdownoptions.lavelhide == 'yes' ){
                        daysTime = '<span class="landshop-count days"><span class="count-inner"><span class="time-count">%-D</span> </span></span>';
                        hours = '<span class="landshop-count hour"><span class="count-inner"><span class="time-count">%-H</span> </span></span>';
                        minutes = '<span class="landshop-count minutes"><span class="count-inner"><span class="time-count">%M</span> </span></span>';
                        second = '<span class="landshop-count second"><span class="count-inner"><span class="time-count">%S</span> </span></span>';
                    }else{
                        daysTime = '<span class="landshop-count days"><span class="count-inner"><span class="time-count">%-D</span> <div class="count-label">'+countdownoptions.landshopcoredaytxt+ '</div></span></span>';
                        hours = '<span class="landshop-count hour"><span class="count-inner"><span class="time-count">%-H</span> <div class="count-label">'+countdownoptions.landshopcorehourtxt+ '</div></span></span>';
                        minutes = '<span class="landshop-count minutes"><span class="count-inner"><span class="time-count">%M</span> <div class="count-label">'+countdownoptions.landshopcoreminutestxt+ '</div></span></span>';
                        second = '<span class="landshop-count second"><span class="count-inner"><span class="time-count">%S</span> <div class="count-label">'+countdownoptions.landshopcoresecondstxt+ '</div></span></span>';
                    }

                    // Total default target time
                    finalTime = daysTime + hours + minutes + second;

                    if ( countdownoptions.landshopcoreday != 'yes' ){
                        finalTime = hours + minutes + second;
                    }
                    if ( countdownoptions.landshopcorehours != 'yes' ){
                        finalTime = daysTime + minutes + second;
                    }
                    if ( countdownoptions.landshopcoreminiute != 'yes' ){
                        finalTime = daysTime + hours + second;
                    }
                    if ( countdownoptions.landshopcoresecond != 'yes' ){
    ...
    var landshop_accordion = function ($scope, $) {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop_Audio_Player.default', AudioPlayerJS);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-switch-addons.default', landshop_switch);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshopcore-countdown-addons.default', WidgetCountdownMapHandler);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-accordion.default', landshop_accordion);
        elementorFrontend.hooks.addAction('frontend/element_ready/cirlce-progress-bar.default', circle_progress_bar);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-campaign-widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-campaign-widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-testimonial-widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-testimonial-widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-history-widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-history-widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-service-widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-service-widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-post-widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-post-widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-donate-widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-donate-widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-team-widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-team-widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop_case_studie_widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop_case_studie_widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-event-widget.default', masonry_lists);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop-event-widget.default', slider_control);
        elementorFrontend.hooks.addAction('frontend/element_ready/landshop_range_slider.default', range_slider);
