<?php
// Creating the widget 
class landshop_author_info extends WP_Widget {
    
    function __construct() {        
        add_action('admin_enqueue_scripts', array($this, 'landshop_media_scripts'));
        parent::__construct( 
            // Base ID of your widget
            'landshop_author_info',
            // Widget name will appear in UI
            __('Author Information', 'landshopcore'), 
            // Widget description
            array( 'description' => __( 'Author information widget.', 'landshopcore' ), ) 
        );
    }    
    public function landshop_media_scripts(){
    ...
    public function widget( $args, $instance ) {
        ...
        $data[] = ( !empty($author_image) ? '<figure class="author-pic"><img src="'.esc_url($author_image).'" alt="'.esc_attr__( 'Author Image','landshopcore' ).'"></figure>' : '' );            
        ...
        ?><div class="media-widget-control">
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>">
                    <?php esc_html_e( 'Widget Title:','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_name'); ?>"><?php esc_html_e( 'Author Name','landshopcore' ); ?></label>
            ...
            <p class="image_upload_part">
                ...
                <?php if( empty($author_image) ): ?>
                    <span class="media-widget-preview">
                        <span class="placeholder upload_image_button"><?php esc_html_e( 'No image selected','landshopcore' ); ?></span>
                    </span>
                <?php else: ?>
                ...
                <span class="media-widget-buttons">
                    <button class="upload_image_button button landshop_image_upload"><?php esc_html_e( 'Add Image','landshopcore' ); ?></button>
                </span>
            </p>    
            <p>
                <label for="<?php echo $this->get_field_id('author_bio'); ?>"><?php esc_html_e( 'Author Bio','landshopcore' ); ?></label>
            ...
            <hr>            
            <p>
                <label for="<?php echo $this->get_field_id('author_facebook'); ?>"><?php esc_html_e( 'Facebook URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_twitter'); ?>"><?php esc_html_e( 'Twitter URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_linkedin'); ?>"><?php esc_html_e( 'Linkedin URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_instagram'); ?>"><?php esc_html_e( 'Instagram URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_youtube'); ?>"><?php esc_html_e( 'Youtube URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_behance'); ?>"><?php esc_html_e( 'Behance URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_dribbble'); ?>"><?php esc_html_e( 'Dribbble URL','landshopcore' ); ?></label>
