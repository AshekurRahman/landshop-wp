<?php
// Creating the widget 
class landshop_social_menu extends WP_Widget {    
    function __construct() {        
        parent::__construct( 
            // Base ID of your widget
            'landshop_social_menu',
            // Widget name will appear in UI
            __('Social Profile', 'landshopcore'), 
            // Widget description
            array( 'description' => __( 'To set your social profile link.', 'landshopcore' ), ) 
        );
    }
        ...
        ?><div class="media-widget-control">
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>">
                    <?php esc_html_e( 'Title:','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('social_facebook'); ?>"><?php esc_html_e( 'Facebook URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('social_twitter'); ?>"><?php esc_html_e( 'Twitter URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('social_linkedin'); ?>"><?php esc_html_e( 'Linkedin URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('social_instagram'); ?>"><?php esc_html_e( 'Instagram URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('social_youtube'); ?>"><?php esc_html_e( 'Youtube URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('social_pinterest'); ?>"><?php esc_html_e( 'Pinterest URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('social_flikr'); ?>"><?php esc_html_e( 'Flikr URL','landshopcore' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('social_whatsapp'); ?>"><?php esc_html_e( 'WhatsApp URL','landshopcore' ); ?></label>
