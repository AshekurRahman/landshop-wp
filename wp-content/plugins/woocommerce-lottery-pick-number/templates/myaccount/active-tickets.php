...
<header class="woocommerce-products-header">
	<h4 class="woocommerce-products-header__title page-title mytickets active"><?php esc_html_e( 'Active Tickets', 'wc-lottery-pn' ); ?></h4>
	<h4 class="woocommerce-products-header__title page-title mytickets"><a href="<?php echo wc_get_account_endpoint_url("comp-tickets-past"); ?>"><?php esc_html_e( 'Past Tickets', 'wc-lottery-pn' ); ?></a></h4>
</header>   
...
if ( is_array( $posts_ids ) && count( $posts_ids ) > 0 ) {
	...
	<div class="woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info">
		<?php esc_html_e( 'No active lottery ticket(s) found.', 'wc-lottery-pn' ); ?>
	</div>
