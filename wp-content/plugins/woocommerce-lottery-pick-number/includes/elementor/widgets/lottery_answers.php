...
class Lottery_Answers extends Base_Widget {

	public function get_name() {
		return 'woocommerce-lottery-answers';
	}

	public function get_title() {
		return __( 'Lottery Answers', 'wc_lottery' );
	}

	public function get_icon() {
		return 'eicon-lottery-answers';
	}

	public function get_keywords() {
		return [ 'woocommerce', 'shop', 'store', 'lottery', 'answers' ];
	}

	protected function _register_controls() {

		$this->start_controls_section(
			'section_lottery_answers_style',
			[
				'label' => __( 'Lottery Answers', 'elementor-pro' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'body:not(.rtl) {{WRAPPER}}:not(.elementor-lottery-answers-block-yes)' => 'margin-right: {{SIZE}}{{UNIT}}',
					'body.rtl {{WRAPPER}}:not(.elementor-lottery-answers-block-yes)' => 'margin-left: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}}.elementor-lottery-answers-block-yes' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
