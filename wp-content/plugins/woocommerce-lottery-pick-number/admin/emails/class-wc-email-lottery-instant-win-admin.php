...
class WC_Email_Lottery_Instant_Win_Admin extends WC_Email {
    ...
    function __construct() {
        ...
        $this->id             = 'lottery_instant_win_admin';
        $this->title          = __( 'Lottery Instant Win Admin', 'wc_lottery' );
        $this->description    = __( 'Lottery won emails are sent to admin when a user wins instant prize.', 'wc_lottery' );
        
        $this->template_html  = 'emails/lottery_instant_win_admin.php';
        $this->template_plain = 'emails/plain/lottery_instant_win_admin.php';
        $this->template_base  =  $wc_lottery->get_path(). 'templates/';
        $this->customer_email = true;
        
        $this->subject        = __( 'Instant prize won on {blogname}', 'wc_lottery');
        $this->heading        = __( 'User have won instant prize in the lottery!', 'wc_lottery');
