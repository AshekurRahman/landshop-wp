...
* Icon render
*/
class Codexse_Icon_manager extends Icons_Manager{

    private static function render_svg_icon( $value ) {
        if ( ! isset( $value['id'] ) ) {
            return '';
        }
        return codexse_is_elementor_version( '>=', '3.5.0' ) ? \Elementor\Core\Files\File_Types\Svg::get_inline_svg( $value['id'] ) : \Elementor\Core\Files\Assets\Svg\Svg_Handler::get_inline_svg( $value['id'] );
    }
