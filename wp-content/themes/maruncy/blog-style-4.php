...
get_template_part('components/layouts/site_header'); ?>
        ...
        ?>
        <section class="section_padding page-section blog-style-4">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                           ...
                           <?php                              
                                   // Start the loop.
                                    while($p_query->have_posts()){
										 ...
										 */                                        
                                        if($p_query->current_post < 5){
                                            if($p_query->current_post % 5 == 1){
                                                ...
                                                ?>
                                                   <div <?php post_class(['post-box small-box',get_post_type()]); ?>>
                                                        <?php 
                                                            if($maruncy_opt['post_thumbnail'] == '1'){
                                                                if(has_post_thumbnail()){
                                                                    maruncy_post_thumbnail('large');
