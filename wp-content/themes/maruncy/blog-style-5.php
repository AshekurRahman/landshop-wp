...
get_template_part('components/layouts/site_header'); ?>
        ...
        ?>
        <section class="section_padding page-section blog-style-5">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row g-5 masonrys">                           
                           <?php                           
                           // Start the loop.
                            while($p_query->have_posts()){
                                ...
                                if($p_query->current_post % 4 == 0){
                                    echo '<div class="col-md-6">';
                                        ?>
                                           <div <?php post_class(['post-box big-box',get_post_type()]); ?>>
                                                <?php 
                                       ...
                                       <?php
                                    echo '</div>';
                                    }elseif($p_query->current_post % 4 == 4){
                                    echo '<div class="col-md-6">';
                                        ?>
                                           <div <?php post_class(['post-box big-box',get_post_type()]); ?>>
                                                <?php 
                                    ...
                                    echo '<div class="col-md-6">';
                                    ?>
                                       <div <?php post_class(['post-box small-box left-align',get_post_type()]); ?>>
                                            <?php 
                                                if($maruncy_opt['post_thumbnail'] == '1'){
                                                    if(has_post_thumbnail()){
                                                        maruncy_post_thumbnail('large');
