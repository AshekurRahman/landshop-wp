...
Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(
        'theme_type' => array(
            'id'       => 'theme_type',
            'type'     => 'select',
            'title'    => esc_html__( 'Theme type', 'landshop' ),
            'options'  => array(
                'default' => esc_html__( 'Default','landshop' ),
                'black' => esc_html__( 'Black','landshop' ),
            ),
            'default'  => 'default',             
        ),
        'layout' => array(
            'id'        => 'page_layout',
            'type'      => 'radio',
            'title'     => esc_html__( 'Page Layout', 'landshop' ),
            'subtitle'  => esc_html__( 'Choose the site layout style.', 'landshop' ),
        ...
        'site_width' => array(
            ...
            'subtitle'  => esc_html__( 'Adjust the overall site width and side-header width.', 'landshop' ),
            'id'        => 'site_width',
            'width'     => true,
            'height'    => false,
            ...
            'type'      => 'dimensions',
            'units'     => array('em','px','%'),
            'desc'      => esc_attr__( 'This setting controls the width of the main site content and the side-header. You can use different units such as em, px, or %. For example, you can set it to 1170px or 90%. Note: The value was changed in landshop to include both the site-width & side-header width, ex: calc(90% + 300px). Leave this as is, or update it with a single percentage, ex: 95%.', 'landshop' ),
            'output'    => '.page__wrapper',
            'required'  => array('page_layout', '=', '1'),
        ),     
        'wide_layout_space' => array(
            'id'             => 'wide_layout_space',
            'type'           => 'spacing',
            'output'         => array( '.page__wrapper' ),
            'mode'           => 'margin',
            'all'            => false,
            'right'          => false,
            'left'           => false,
            'units'          => array( 'em', 'px', '%' ),
            'units_extended' => 'true',
            'title'          => esc_html__( 'Boxed Mode Offset', 'landshop' ),
            'subtitle'       => esc_html__( 'Adjust the top/bottom offset of the page background in boxed mode.', 'landshop' ),
            'required'       => array('page_layout', '=', '1'),
        ),     
        'wide_layout_padding' => array(
            ...
            'units'          => array( 'em', 'px', '%' ),
            'units_extended' => 'true',
            'title'          => esc_html__( 'Boxed Mode Inner Padding', 'landshop' ),
            'subtitle'       => esc_html__( 'Adjust the left and right padding of the boxed background.', 'landshop' ),
            'required'       => array('page_layout', '=', '1'),
        ),
        'page_bg_color' => array(         
            'id'        => 'page_bg_color',
            ...
            'subtitle'  => esc_html__( 'Adjust the background and opacity for the page.', 'landshop' ),
            'output'    => ['.main_wrapper'],
            'required'  => array('page_layout', '=', '1'),
        ),        
    )
...
Redux::setSection($opt_name , array(
    ...
    'fields'           => array(
        'color_info' => array(
            ...
            'style' => 'info',
            'desc'  => esc_html__('This tab contains general color options. Additional color options for specific areas can be found within other tabs. For example, for menu color options, go to the menu tab.', 'landshop')
        ),
        'primary_color' => array(
            'id'        => 'primary_color',
            'type'      => 'color',
            'title'     => esc_html__('Primary Color', 'landshop'),
            'subtitle'  => esc_html__('Choose the main highlight color for your theme.', 'landshop'),
            'default'   => '#FF6B31',
            'validate'  => 'color',
        ),
        'heading_color' => array(
            'id'        => 'heading_color',
            'type'      => 'color',
            'title'     => esc_html__('Heading Text Color', 'landshop'),
            'subtitle'  => esc_html__('Choose the color for headings throughout the theme.', 'landshop'),
            'default'   => '#191B1E',			
            'validate'  => 'color',
        ),
        'white_color' => array(
            'id'        => 'white_color',
            'type'      => 'color',
            'title'     => esc_html__('White Text Color', 'landshop'),
            'subtitle'  => esc_html__('Choose the color for white text throughout the theme.', 'landshop'),
            'default'   => '#ffffff',			
            'validate'  => 'color',
        ),
        'text_color' => array(
            ...
            'subtitle'  => esc_html__('Choose the color for light text throughout the theme.', 'landshop'),
            'default'   => '#3E4245',			
            'validate'  => 'color',
        ),   
        'gray_color' => array(
            'id'        => 'gray_color',
            'type'      => 'color',
            'title'     => esc_html__('Gray Background Color', 'landshop'),
            'subtitle'  => esc_html__('Choose the color for gray background elements, borders, and lines throughout the theme.', 'landshop'),
            'default'   => '#ededed',			
            'validate'  => 'color',
        ),
        'dark_color' => array(
            'id'        => 'dark_color',
            'type'      => 'color',
            'title'     => esc_html__('Dark Background Color', 'landshop'),
            'subtitle'  => esc_html__('Choose the color for dark background elements throughout the theme.', 'landshop'),
            'default'   => '#191B1E',			
            'validate'  => 'color',
        ),
        'body_color' => array(
            'id'        => 'body_background',
            'type'      => 'color',
            'title'     => esc_html__('Body Background Color', 'landshop'),
            'subtitle'  => esc_html__('Choose the background color for the body throughout the theme.', 'landshop'),
            'default'   => '#ffffff',			
            'validate'  => 'color',
        ),        
	)
...
Redux::setSection($opt_name , array(
    ...
    'fields'           => array(
        'navbar_width' => array(
            'title'     => esc_html__( 'Navbar Width', 'landshop' ),
            'subtitle'  => esc_html__( 'Adjust the width of the navbar container.', 'landshop' ),
            'id'        => 'navbar_width',
            'width'     => true,
            'height'    => false,
            'default'   => array('width' => '1700'),
            'type'      => 'dimensions',
            'units'     => array('em','px','%'),
            'output'    => '.navbar__area .container__large',
        ),    
        'navbar_style' => array(
            'id'       => 'navbar_style',
            'type'     => 'select',
            ...
            'options'  => array(
                'style_one' => esc_html__( 'Style One','landshop' ),
                'style_two' => esc_html__( 'Style Two','landshop' ),
            ),
            'default'  => 'style_one',             
        ),
        'navbar_transparent' => array(
            ...
            'type'     => 'select',
            'title'    => esc_html__( 'Transparency', 'landshop' ),
            'options'  => array(
                'static_menu' => esc_html__( 'Static','landshop' ),
                'transparent_menu dark_menu' => esc_html__( 'Dark Transparent','landshop' ),
		...
		'sticky_offset' => array(
         ...
         array(
            'id'       => 'navbar__area_background',
            'type'     => 'color_rgba',
            'title'    => esc_html__( 'Background Color', 'landshop' ),
            'output'   => array( '.navbar__area' ),
            'mode'     => 'background',
            'validate' => 'colorrgba'
        ),
         array(
            'id'       => 'navbar__area_border',
            'type'     => 'border',
        ...
        array(
            ...
            'type'     => 'background',
            'output'   => array( '.sticky .navbar__area' ),
...
// Action button
Redux::setSection($opt_name , array(
    'title'            => esc_html__( 'Alert', 'landshop' ),
    'id'               => 'nav_alert_opt_sec',
    'subsection'       => true,
    'icon'             => '',
    'fields'           => array(
        array(
            'title'     => esc_html__('Alert Visibility', 'landshop'),
            'id'        => 'nav_alert_display',
            'subtitle'  => esc_html__('Do you want to show the Alert at header top?', 'landshop'),
            'type'      => 'switch',
        ...
        array(
            'title'     => esc_html__('Alert Text', 'landshop'),
            'subtitle'  => esc_html__('Enter type your alert content.', 'landshop'),
            'id'        => 'nav_alert_content',
            'type'      => 'text',
            'default'   => esc_html__('Wireless Webcam, Satisfaction Guaranteed Small Photo, Special Photo', 'landshop'),
            'required'  => array('nav_alert_display', '=', '1')
        ),
        array(
            'title'     => esc_html__('Text Color', 'landshop'),
            'subtitle'  => esc_html__('You can change alert text color.', 'landshop'),
            'id'        => 'alert_text_color',
            'type'      => 'color',
            'output'    => array('.header_alert, .header_alert .close'),
        ),
        array(
            'title'     => esc_html__('Background Color', 'landshop'),
            'subtitle'  => esc_html__('You can change alert background color.', 'landshop'),
            'id'        => 'alert_text_bg_color',
            'type'      => 'color',
            'mode'      => 'background',
            'output'    => array('.header_alert'),
        ),
    )
));
...
Redux::setSection($opt_name , array(
    ...
    'fields'           => array(	
        ...
        array(
            ...
            'type'      => 'dimensions',
            'units'     => array('em','px','%'),
            'output'    => '.navbar__area .nav__logo img'
        ),
        array(
            ...
            'id'        => 'logo_padding',
            'type'      => 'spacing',
            'output'    => array( '.navbar__area .nav__logo' ),
            'mode'      => 'padding',
...
Redux::setSection($opt_name , array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'id'        => 'nav_shop_color',
            'type'      => 'color',
            'output'    => array('.navbar__area .cart_toggle'),
        ),
        array(
            ...
            'type'      => 'color',
            'output'    => array('.navbar__area .cart_toggle:hover'),
        ),
        array(
...
Redux::setSection($opt_name , array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'id'        => 'nav_search_color',
            'type'      => 'color',
            'output'    => array('.navbar__area .search_toggle'),
        ),
        array(
            'title'     => esc_html__('Hover Color', 'landshop'),
            'subtitle'  => esc_html__('Control the button hover text color.', 'landshop'),
            ...
            'type'      => 'color',
            'output'    => array('.navbar__area .search_toggle:hover'),
        ),
        array(
            'title'     => esc_html__('BG Color', 'landshop'),
            'subtitle'  => esc_html__('Control the button background color.', 'landshop'),
...
Redux::setSection($opt_name , array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'type'      => 'color',
            'output'    => array('.navbar__area .mobile_menu_toggle'),
        ),
        array(
            'title'     => esc_html__('Hover Color', 'landshop'),
            'subtitle'  => esc_html__('Control the button hover text color.', 'landshop'),
            ...
            'type'      => 'color',
            'output'    => array('.navbar__area .mobile_menu_toggle:hover'),
        ),
        array(
            'title'     => esc_html__('BG Color', 'landshop'),
            'subtitle'  => esc_html__('Control the button background color.', 'landshop'),
...
Redux::setSection($opt_name , array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'id'        => 'nav_button_color',
            'type'      => 'color',
            'output'    => array('.navbar__area .primary_button'),
            'required'  => array('nav_button_display', '=', '1'),
        ),
        array(
            'title'     => esc_html__('Hover Color', 'landshop'),
            ...
            'type'      => 'color',
            'output'    => array('.navbar__area .primary_button:hover'),
            'required'  => array('nav_button_display', '=', '1'),
        ),
        array(
            'title'     => esc_html__('BG Color', 'landshop'),
...
// Action button
Redux::setSection($opt_name , array(
    'title'            => esc_html__( 'Toggle Sidebar', 'landshop' ),
    'id'               => 'nav_toggle_sidebar',
    'subsection'       => true,
    'icon'             => '',
    'fields'           => array(
        array(
            'title'     => esc_html__('Navbar Toggle Sidebar', 'landshop'),
            'id'        => 'nav_toggle_sidebar',
            'subtitle' => wp_kses(sprintf(__('Activate this switch to display the navbar toggle sidebar. To add widgets to this sidebar, <a href="%s">click here</a> and select the desired widgets.', 'landshop'), admin_url('widgets.php')), array('a' => array('href' => array()))),
            'type'      => 'switch',
            'on'        => esc_html__('Yes', 'landshop'),
            'off'       => esc_html__('No', 'landshop'),
            'default'   => false
...
Redux::setSection( $opt_name, array(
    ...
    'id'               => 'page_header_sub__title',
    'subsection'       => true,
    'customizer_width' => '400px',
    'fields'           => array(
        array(
            'id'       => 'sub__title_format',
            'type'     => 'radio',
        ...
        array(
            ...
            'required' => array( 'sub__title_format','=','2')
        ),
        array(
            ...
            'default'  => '<big class="primary__text mx-3">&#8226;</big>',
            'required' => array( 'sub__title_format','=','2')
        ),        
        array(
            'id'       => 'custom_sub__title',
            'type'     => 'text',
            ...
            'required' => array( 'sub__title_format','=','3')
        ),
        array(
            'id'          => 'page_sub__title_typography',
            'type'        => 'typography',
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'id'        => 'post_box_padding',
            'type'      => 'spacing',
            'output'    => array( '.post__box .content' ),
            'mode'      => 'padding',
            'units'     => array( 'em', 'px', '%' ),
            'units_extended' => 'true',
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'type'      => 'spacing',
            'output'    => array( '.post__box .post__media' ),
            'mode'      => 'margin',
            'units'     => array( 'em', 'px', '%' ),
            'units_extended' => 'true',
        ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'type'      => 'color',
            'output'    => array('.post__box .title:hover a'),
        ),
        array(
            'title'     => esc_html__('Margin', 'landshop'),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'text-transform'    => true,
            'all_styles'  => true,
            'output'      => array( '.post__box .meta_list','.post__box .meta_list a' ),
        ...
        array(
            ...
            'type'      => 'color',
            'output'    => array('.post__box .meta_list i'),
        ),
        array(
            ...
            'type'      => 'color',
            'output'    => array('.post__box .meta_list a:hover'),
        ),
        ...
        array(
            ...
            'type'      => 'spacing',
            'output'    => array( '.post__box .meta_list' ),
            'mode'      => 'margin',
            'units'     => array( 'em', 'px', '%' ),
            'units_extended' => 'true',
        ),
...
if( class_exists('woocommerce') ):
Redux::setSection( $opt_name, array(
    'title'            => esc_html__( 'Shop Options', 'landshop' ),
    'id'               => 'product_options',
    'desc'             => esc_html__( 'Customize your shop page options here.', 'landshop' ),
    'customizer_width' => '400px',
    'icon'             => 'el el-shopping-cart',
) );

Redux::setSection( $opt_name, array(
    'title'            => esc_html__( 'Product list', 'landshop' ),
    'id'               => 'product_list_options',
    'desc'             => esc_html__( 'You can change product list options from here.', 'landshop' ),
    'customizer_width' => '400px',
    'subsection' => true,
	'fields'     => array(
        ...
        array(
            'title'     => esc_html__('Site Header', 'landshop'),
            'subtitle'  => esc_html__('Choose whether to hide or show the site header on product list page.', 'landshop'), // Subtitle added
            'id'        => 'pro_list_header',
            'type'      => 'switch',
            'on'        => esc_html__('Show', 'landshop'),
            'off'       => esc_html__('Hide', 'landshop'),
        ...
        array(
            'id'       => 'product_list_style',
            'type'     => 'image_select',
            'height'    => '100px',
            'title'    => __('Select Card Style', 'landshop'),
            'subtitle' => __('Choose a product card style for your product list.', 'landshop'),
            'desc'     => __('Preview the available styles and select the one that best fits your website design.', 'landshop'),
            'options'  => Array(
                'one' => Array (
                     'alt'  => 'One',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-1.png'),
                ),
                'two' => Array (
                     'alt'  => 'Two',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-2.png'),
                ),
                'three' => Array (
                     'alt'  => 'Three',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-3.png'),
                ),
                'four' => Array (
                     'alt'  => 'Four',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-4.png'),
                ),
                'five' => Array (
                     'alt'  => 'Five',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-5.png'),
                ),
                'six' => Array (
                     'alt'  => 'Six',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-6.png'),
                ),
                'seven' => Array (
                     'alt'  => 'Seven',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-7.png'),
                ),
                'eight' => Array (
                     'alt'  => 'Eight',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-8.png'),
                ),
                'nine' => Array (
                     'alt'  => 'Nine',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-9.png'),
                ),
                'ten' => Array (
                     'alt'  => 'Ten',
                     'img'  => get_theme_file_uri('/assets/images/shop/product-card-10.png'),
                )
            ),
            'default'  => 'one'
        ),
        ...
        array(
            'title'     => esc_html__('Flash Sale Badge', 'landshop'),
            'subtitle'  => esc_html__('Choose whether to hide or show the badge on product card.', 'landshop'), // Subtitle added
            'id'        => 'prod__flash_switch',
            'type'      => 'switch',
            'on'        => esc_html__('Show', 'landshop'),
            'off'       => esc_html__('Hide', 'landshop'),
            'default'   => true
        ...
        array(
            'title'     => esc_html__('Wishlist Button', 'landshop'),
            'subtitle'  => esc_html__('Choose whether to hide or show the wishlist button on product card.', 'landshop'), // Subtitle added
            'id'        => 'prod__wish_button',
            'type'      => 'switch',
            'on'        => esc_html__('Show', 'landshop'),
            'off'       => esc_html__('Hide', 'landshop'),
            'default'   => true
...
Redux::setSection( $opt_name, array(
	...
	'fields'     => array(           
		...
		array(
            ...
            'default'  => esc_html__( '&copy; 2023 landshop - IT Solution Company . All Rights Reserved.','landshop' ),
            'required'  => array( 'footer_template', '=', '' ),
        ),
    ),
) );
...
Redux::setSection( $opt_name , array(
    ...
    'fields'           => array(
        ...
        array(
            'title'     => esc_html__('Loader Dimensions', 'landshop'),
            'id'        => 'loader_dimensions',
            'type'      => 'dimensions',
            'units'     => array('em','px','%'),
            'output'    => '.preloader .loader-image img'
        ),
		'page_bg_color' => array(         
...
Redux::setSection($opt_name, array(
    'title'      => esc_html__('Custom Codes', 'landshop'), // Updated section title
    'id'         => 'custom_codes_options',
    'icon'       => 'el el-edit',
    'fields'     => array(
        array(
           'id'       => 'custom_css',
           'type'     => 'ace_editor',
           'title'    => esc_html__('Custom CSS Code', 'landshop'), // Updated field title
           'subtitle' => esc_html__('Add your custom CSS code here.', 'landshop'), // Updated field subtitle
           'mode'     => 'css',
           'theme'    => 'monokai'
       ),
       array(
          'id'       => 'custom_script',
          'type'     => 'ace_editor',
          'title'    => esc_html__('Custom JavaScript Code', 'landshop'), // Updated field title
          'subtitle' => esc_html__('Add your custom JavaScript code here.', 'landshop'), // Updated field subtitle
          'mode'     => 'javascript',
          'theme'    => 'monokai'
      ),
    )
